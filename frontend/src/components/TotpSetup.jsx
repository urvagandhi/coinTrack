                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex items-center space-x-2">
                            <code className="flex-1 bg-gray-100 p-2 rounded text-sm font-mono break-all border">
                                {setupData?.secret}
                            </code>
    ...
    if (step === 'backup') {
        return (
            <Card className="w-full max-w-md mx-auto border-green-200 shadow-green-100">
                ...
                <CardContent>
                    <div className="bg-gray-50 border rounded-lg p-4 grid grid-cols-2 gap-2 text-sm font-mono">
                        {backupCodes.map((code, i) => (
                            <div key={i} className="bg-white p-1 px-2 border rounded text-center text-gray-700">
                                {code}
                            </div>
                        ))}
                    </div>
