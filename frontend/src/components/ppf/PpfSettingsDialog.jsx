...
export default function PpfSettingsDialog({
  isOpen,
  onClose,
  settings,
  onSaveSettings,
          ...
          >
            <div className='space-y-1.5'>
              ...
              <p className='text-[11px] text-muted-foreground'>
                Stored once and displayed in the ledger header. You can edit it
                at any time here.
              </p>
            </div>
            ...
            <div className='space-y-1.5 pt-2'>
              ...
              <select
                ...
                onChange={e =>
                  setFormData({ ...formData, extensionMode: e.target.value })
                }
                className='ed-input w-full'
              >
                <option value='WITHOUT_CONTRIBUTION'>
                  Retain Without Contributions (Default)
                </option>
                <option value='WITH_CONTRIBUTION'>
                  Extend With Contributions (Form H)
                </option>
              </select>
              <p className='text-[11px] text-muted-foreground leading-tight'>
                This determines withdrawal limits and contribution eligibility
                after 15 years.
              </p>
            </div>
          </form>
