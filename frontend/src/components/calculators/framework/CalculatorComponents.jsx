  ...
  return (
    <section className='bg-background border border-hairline'>
      <div className='border-b border-hairline px-5 py-3.5 flex items-baseline gap-3'>
        <span className='display-num text-[10px] text-[hsl(var(--accent))]'>
          §A
        </span>
...
export function ResultCard({ title = 'The Result', children, isEmpty }) {
    ...
    return (
      <section className='bg-background border border-hairline h-fit'>
        <div className='border-b border-hairline px-5 py-3.5 flex items-baseline gap-3'>
          ...
          <h2 className='eyebrow-strong text-muted-foreground'>
            Awaiting figures
          </h2>
        </div>
        <div className='py-14 px-6 text-center'>
          ...
          <p className='font-serif italic text-[16px] text-muted-foreground leading-snug'>
            Set the values opposite and press{' '}
  ...
  return (
    <section className='bg-background border border-hairline h-fit'>
      <div className='border-b border-hairline px-5 py-3.5 flex items-baseline gap-3'>
        <span className='display-num text-[10px] text-[hsl(var(--gain))]'>
          §B
        </span>
        <h2 className='eyebrow-strong'>{title}</h2>
          ...
          <thead className='sticky top-0 z-10 bg-background'>
            <tr className='border-b-2 border-foreground/80'>
              {headers.map((header, i) => (
                <th key={i} className='py-2.5 px-5 text-left eyebrow'>
                  {header}
                </th>
              ))}
            </tr>
...
const DISCLAIMER_VARIANT = {
  warning: {
    ...
    tint: 'bg-[hsl(var(--chart-4)/0.05)]',
    icon: 'text-[hsl(var(--chart-4))]',
  },
  info: {
    border: 'border-[hsl(var(--accent))]',
    tint: 'bg-[hsl(var(--accent)/0.05)]',
...
export function DisclaimerBanner({
  ...
  return (
    <div
      className={cn(
        'mt-4 border-l-2 px-4 py-3 flex items-start gap-3',
        v.border,
        v.tint
      )}
    >
      <Info
        size={13}
        className={cn('flex-shrink-0 mt-1', v.icon)}
        aria-hidden='true'
      />
      <div>
