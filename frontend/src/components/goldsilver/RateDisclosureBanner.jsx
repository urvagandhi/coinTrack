...
export default function RateDisclosureBanner({
  goldSnapshot,
  silverSnapshot,
  onOpenSettings,
  className,
    ...
    >
      <div className='flex items-center gap-2 flex-wrap'>
        ...
        <span>
          {isStale ? (
            <>
              Rate may be outdated — GoldAPI unreachable, showing last known
              price.
            </>
          ) : (
            <>
              Live rates powered by <strong>GoldAPI.io</strong> — global spot
              price + local duty/premium (currently{' '}
              <strong>+{premiumPercent}%</strong>) to approximate Indian retail
              rates. Actual jeweller quotes may vary.
            </>
          )}
