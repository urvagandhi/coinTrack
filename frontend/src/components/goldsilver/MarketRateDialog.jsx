      ...
      <DialogContent className='sm:max-w-md bg-card border-border'>
        ...
        <form onSubmit={handleSubmit} className='space-y-4 pt-2'>
          <p className='text-[12px] text-muted-foreground'>
            This will update the pinned market rate across all your investments
            of type <strong className='text-foreground'>{metalType}</strong>{' '}
            that are set to{' '}
            <code className='text-amber-500 font-mono'>MANUAL</code> mode.
          </p>
          ...
          <div className='flex items-center gap-2 pt-1'>
            ...
            />
            <label
              htmlFor='includeMaturedCheck'
              className='text-[12px] font-mono text-muted-foreground cursor-pointer'
            >
