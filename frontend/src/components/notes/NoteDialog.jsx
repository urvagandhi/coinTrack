      ...
      <div className='relative ed-card w-full max-w-xl p-6 z-10 animate-in fade-in zoom-in-95 duration-200'>
        ...
        <div className='mb-4'>
          <p className='eyebrow mb-2'>
            Tone — {COLORS.find(c => c.key === selectedColor)?.name}
          </p>
        ...
        <div className='mb-5 pb-5 border-b border-border'>
          ...
          <div className='flex flex-wrap items-center gap-1.5'>
            {tags.map(tag => (
              <span
                key={tag}
                className='text-[10px] font-mono uppercase tracking-[0.08em] border border-border bg-muted/40 rounded-sm px-1.5 py-0.5 flex items-center gap-1 text-muted-foreground'
              >
                #{tag}
                <button
        ...
        <div className='flex items-center justify-between'>
          ...
          <div className='flex gap-2 ml-auto'>
            <button onClick={onClose} className='ed-btn ed-btn-ghost'>
              Cancel
            </button>
            <button
