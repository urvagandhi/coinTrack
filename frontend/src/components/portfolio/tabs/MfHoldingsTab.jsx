            ...
            <table className='ed-table'>
              ...
              <tbody>
                {holdings.map((h, i) => {
                  const pnl =
                    h.pnl ??
                    ((h.lastPrice ?? 0) - (h.averagePrice ?? 0)) *
                      (h.quantity ?? 0);
                    ...
                    <tr key={h.tradingsymbol || h.folio || i}>
                      <td>
                        <div className='flex items-baseline gap-3 max-w-md'>
                          ...
                          <div>
                            <p className='text-[13px] font-medium text-foreground line-clamp-2 tracking-tight'>
