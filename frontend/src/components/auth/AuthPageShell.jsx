    ...
    <div className='min-h-screen bg-background text-foreground flex flex-col'>
        ...
        <div className='w-full grid grid-cols-1 lg:grid-cols-[1fr_minmax(0,520px)_1fr]'>
          ...
          <aside className='hidden lg:flex flex-col justify-between border-r border-hairline p-10 bg-muted/30'>
            <div>
              ...
              <p className='display-num text-[44px] leading-none text-foreground'>
                §{index}
              </p>
              <p className='mt-2 font-serif italic text-[18px] text-muted-foreground'>
                {kicker}
              </p>
            </div>
            ...
            <div>
              ...
              <p className='font-serif italic text-[14px] text-foreground mt-1'>
                Identity & Access
              </p>
            </div>
          </aside>
          ...
          <aside className='hidden lg:flex flex-col p-10'>
            <div>
              ...
              <p className='font-serif italic text-[14px] text-foreground leading-snug'>
                {dateString}
              </p>
            ...
            <div className='mt-auto'>
              ...
              <p className='mt-1 text-[12px] text-muted-foreground leading-relaxed'>
                A personal ledger for the modern investor. Set in{' '}
      ...
      <footer className='border-t border-hairline'>
        <div className='max-w-7xl mx-auto px-4 sm:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-2'>
          <p className='eyebrow'>
            &copy; {new Date().getFullYear()} CoinTrack — Printed in Browser
          </p>
          {showFooterLinks && (
