...
export const calculatorService = {
  ...
  calculateSip: (data, debug = false) =>
    api
      .post(
        `/api/calculators/investment/sip${debug ? '?debug=true' : ''}`,
        data
      )
      .then(res => res.data),
  ...
  calculateStepUpSip: (data, debug = false) =>
    api
      .post(
        `/api/calculators/investment/step-up-sip${debug ? '?debug=true' : ''}`,
        data
      )
      .then(res => res.data),
  ...
  calculateLumpsum: (data, debug = false) =>
    api
      .post(
        `/api/calculators/investment/lumpsum${debug ? '?debug=true' : ''}`,
        data
      )
      .then(res => res.data),
  ...
  calculateCagr: (data, debug = false) =>
    api
      .post(
        `/api/calculators/investment/cagr${debug ? '?debug=true' : ''}`,
        data
      )
      .then(res => res.data),
  ...
  calculateXirr: (data, debug = false) =>
    api
      .post(
        `/api/calculators/investment/xirr${debug ? '?debug=true' : ''}`,
        data
      )
      .then(res => res.data),
  ...
  calculateStockAverage: (data, debug = false) =>
    api
      .post(
        `/api/calculators/investment/stock-average${debug ? '?debug=true' : ''}`,
        data
      )
      .then(res => res.data),
  ...
  calculateInflation: (data, debug = false) =>
    api
      .post(
        `/api/calculators/investment/inflation${debug ? '?debug=true' : ''}`,
        data
      )
      .then(res => res.data),
  ...
  calculateMutualFundReturns: (data, debug = false) =>
    api
      .post(
        `/api/calculators/investment/mutual-fund-returns${debug ? '?debug=true' : ''}`,
        data
      )
      .then(res => res.data),
  ...
  calculateEmi: (data, debug = false) =>
    api
      .post(`/api/calculators/loans/emi${debug ? '?debug=true' : ''}`, data)
      .then(res => res.data),
  ...
  calculateHomeLoanEmi: (data, debug = false) =>
    api
      .post(
        `/api/calculators/loans/home-loan-emi${debug ? '?debug=true' : ''}`,
        data
      )
      .then(res => res.data),
  ...
  calculateCarLoanEmi: (data, debug = false) =>
    api
      .post(
        `/api/calculators/loans/car-loan-emi${debug ? '?debug=true' : ''}`,
        data
      )
      .then(res => res.data),
  ...
  calculateSimpleInterest: (data, debug = false) =>
    api
      .post(
        `/api/calculators/loans/simple-interest${debug ? '?debug=true' : ''}`,
        data
      )
      .then(res => res.data),
  ...
  calculateCompoundInterest: (data, debug = false) =>
    api
      .post(
        `/api/calculators/loans/compound-interest${debug ? '?debug=true' : ''}`,
        data
      )
      .then(res => res.data),
  ...
  compareFlatVsReducing: (data, debug = false) =>
    api
      .post(
        `/api/calculators/loans/flat-vs-reducing${debug ? '?debug=true' : ''}`,
        data
      )
      .then(res => res.data),
  ...
  calculatePpf: (data, debug = false) =>
    api
      .post(`/api/calculators/savings/ppf${debug ? '?debug=true' : ''}`, data)
      .then(res => res.data),
  ...
  calculateEpf: (data, debug = false) =>
    api
      .post(`/api/calculators/savings/epf${debug ? '?debug=true' : ''}`, data)
      .then(res => res.data),
  ...
  calculateFd: (data, debug = false) =>
    api
      .post(`/api/calculators/savings/fd${debug ? '?debug=true' : ''}`, data)
      .then(res => res.data),
  ...
  calculateRd: (data, debug = false) =>
    api
      .post(`/api/calculators/savings/rd${debug ? '?debug=true' : ''}`, data)
      .then(res => res.data),
  ...
  calculateSsy: (data, debug = false) =>
    api
      .post(`/api/calculators/savings/ssy${debug ? '?debug=true' : ''}`, data)
      .then(res => res.data),
  ...
  calculateNps: (data, debug = false) =>
    api
      .post(`/api/calculators/savings/nps${debug ? '?debug=true' : ''}`, data)
      .then(res => res.data),
  ...
  calculateNsc: (data, debug = false) =>
    api
      .post(`/api/calculators/savings/nsc${debug ? '?debug=true' : ''}`, data)
      .then(res => res.data),
  ...
  calculateScss: (data, debug = false) =>
    api
      .post(`/api/calculators/savings/scss${debug ? '?debug=true' : ''}`, data)
      .then(res => res.data),
  ...
  calculateMis: (data, debug = false) =>
    api
      .post(`/api/calculators/savings/mis${debug ? '?debug=true' : ''}`, data)
      .then(res => res.data),
  ...
  calculateApy: (data, debug = false) =>
    api
      .post(`/api/calculators/savings/apy${debug ? '?debug=true' : ''}`, data)
      .then(res => res.data),
  ...
  calculateIncomeTax: (data, debug = false) =>
    api
      .post(
        `/api/calculators/tax/income-tax${debug ? '?debug=true' : ''}`,
        data
      )
      .then(res => res.data),
  ...
  calculateHra: (data, debug = false) =>
    api
      .post(`/api/calculators/tax/hra${debug ? '?debug=true' : ''}`, data)
      .then(res => res.data),
  ...
  calculateSalary: (data, debug = false) =>
    api
      .post(`/api/calculators/tax/salary${debug ? '?debug=true' : ''}`, data)
      .then(res => res.data),
  ...
  calculateGratuity: (data, debug = false) =>
    api
      .post(`/api/calculators/tax/gratuity${debug ? '?debug=true' : ''}`, data)
      .then(res => res.data),
  ...
  calculateGst: (data, debug = false) =>
    api
      .post(`/api/calculators/tax/gst${debug ? '?debug=true' : ''}`, data)
      .then(res => res.data),
  ...
  calculateTds: (data, debug = false) =>
    api
      .post(`/api/calculators/tax/tds${debug ? '?debug=true' : ''}`, data)
      .then(res => res.data),
  ...
  calculateBrokerage: (data, debug = false) =>
    api
      .post(
        `/api/calculators/trading/brokerage${debug ? '?debug=true' : ''}`,
        data
      )
      .then(res => res.data),
  ...
  calculateMargin: (data, debug = false) =>
    api
      .post(
        `/api/calculators/trading/margin${debug ? '?debug=true' : ''}`,
        data
      )
      .then(res => res.data),
  ...
  calculateRetirement: (data, debug = false) =>
    api
      .post(
        `/api/calculators/planning/retirement${debug ? '?debug=true' : ''}`,
        data
      )
      .then(res => res.data),
};
