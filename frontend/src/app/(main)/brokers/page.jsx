    ...
    <div className='space-y-10'>
      <header className='pb-6 border-b border-hairline'>
        ...
        <h1 className='display-serif text-[40px] md:text-[56px] text-foreground mb-3'>
          Broker{' '}
          <span className='italic text-[hsl(var(--accent))]'>Integrations</span>
        </h1>
        <p className='font-serif italic text-[15px] text-muted-foreground max-w-2xl leading-relaxed'>
          Authorise your brokerage accounts to syndicate holdings, positions,
          and funds. CoinTrack reads only — it cannot trade on your behalf.
        </p>
      </header>
      ...
      <div className='ed-card relative px-6 py-5 flex items-start gap-4 mt-2'>
        ...
        <div>
          ...
          <p className='text-[12px] text-muted-foreground font-serif italic leading-relaxed'>
            Credentials are encrypted with AES-256-GCM before storage. CoinTrack
            reads portfolio data only — placement, modification, or cancellation
            of orders is impossible by design.
          </p>
        </div>
      </div>
    </div>
