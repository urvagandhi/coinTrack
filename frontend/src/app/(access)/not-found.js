  ...
  return (
    <div className='min-h-screen bg-background text-foreground flex flex-col relative overflow-x-hidden'>
      ...
      <div className='min-h-screen flex flex-col relative'>
        {/* Background Image/Pattern spanning the whole screen */}
        <div
        ...
        <header className='border-b border-hairline relative z-10 bg-background'>
              ...
              <section className='lg:col-span-7 relative'>
                ...
                <div className='relative'>
                  <p
                    ...
                    aria-hidden='true'
                  >
                    4<span className='italic text-[hsl(var(--accent))]'>0</span>
                    4
                  </p>
                  <div
                ...
                <p className='mt-5 font-serif italic text-[17px] sm:text-[18px] text-muted-foreground leading-snug max-w-xl'>
                  It may have been retired, relocated, or never set in type at
                  all. Sign in to access the rest of the edition.
                </p>
              ...
              <aside className='lg:col-span-5 lg:border-l border-hairline lg:pl-10'>
                ...
                <div className='mt-8 relative'>
                  ...
                  <p className='pl-6 font-serif italic text-[15px] text-muted-foreground leading-snug'>
                    A locked door is not a refusal — only an invitation to
