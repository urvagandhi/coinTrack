...
export default function ForgotPasswordPage() {
  ...
  return (
    <AuthPageShell
      ...
      asideQuote={
        '"Lost passwords are footnotes — they require care, but never alarm."'
      }
    >
      {!submitted ? (
        <>
          <form onSubmit={handleSubmit} className='space-y-5'>
            ...
            <AuthFormField
              ...
              id='identifier'
              hint='Whichever you used to register.'
            >
        ...
        <div className='space-y-6'>
          <div className='flex items-start gap-4 border-l-2 border-[hsl(var(--gain))] bg-[hsl(var(--gain)/0.06)] px-4 py-4'>
            ...
            <div className='flex-1'>
              ...
              <p className='text-[13px] text-foreground leading-snug'>
                ...
                <span className='font-mono text-foreground'>{identifier}</span>,
          ...
          <div className='border border-hairline bg-muted/30 px-4 py-3'>
            ...
            <p className='text-[12px] text-muted-foreground leading-relaxed'>
              ...
              minutes. The link expires in{' '}
              <span className='font-mono text-foreground'>10 minutes</span>.
            </p>
          </div>
