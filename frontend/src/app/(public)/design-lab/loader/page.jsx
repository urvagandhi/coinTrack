      ...
      <main className='flex-1 max-w-7xl mx-auto w-full p-6 sm:p-8 space-y-12'>
        ...
        <div>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
            {/* Card Payment */}
            <div className='relative rounded-2xl border border-hairline bg-gradient-to-b from-card/80 to-card/40 backdrop-blur-xl p-8 flex flex-col items-center justify-center overflow-hidden shadow-xl group transition-all min-h-[320px]'>
