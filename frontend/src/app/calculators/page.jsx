    ...
    calculators: [
      {
        id: 'sip',
        name: 'SIP Calculator',
        description: 'Returns on systematic monthly investments',
      },
      {
        id: 'step-up-sip',
        name: 'Step-Up SIP',
        description: 'Increasing instalments over time',
      },
      {
        id: 'lumpsum',
        name: 'Lumpsum',
        description: 'Future value of a one-time investment',
      },
      ...
      },
      {
        id: 'stock-average',
        name: 'Stock Average',
        description: 'Average price across purchases',
      },
      {
        id: 'inflation',
        name: 'Inflation',
  ...
  },
  {
    ...
    calculators: [
      { id: 'ppf', name: 'PPF', description: 'Public Provident Fund corpus' },
      {
        id: 'epf',
        name: 'EPF',
        description: 'Employee Provident Fund estimate',
      },
      {
        id: 'fd',
        name: 'Fixed Deposit',
        description: 'Bank FD maturity & interest',
      },
      {
        id: 'rd',
        name: 'Recurring Deposit',
        description: 'Monthly deposit maturity',
      },
      ...
      { id: 'nsc', name: 'NSC', description: 'National Savings Certificate' },
      {
        id: 'scss',
        name: 'SCSS',
        description: 'Senior Citizens Savings Scheme',
      },
      {
        id: 'mis',
        name: 'PO MIS',
        description: 'Post Office Monthly Income Scheme',
      },
    ...
    calculators: [
      {
        id: 'emi',
        name: 'EMI Calculator',
        description: 'Standard loan instalment',
      },
      {
        id: 'home-loan-emi',
        name: 'Home Loan',
        description: 'Residential loan instalment',
      },
      {
        id: 'car-loan-emi',
        name: 'Car Loan',
        description: 'Auto loan instalment',
      },
      {
        id: 'simple-interest',
        name: 'Simple Interest',
        description: 'Linear interest accrual',
      },
      {
      ...
      {
        id: 'flat-vs-reducing',
        name: 'Flat vs Reducing',
        description: 'Two methods, side by side',
      },
    ],
  },
  {
    ...
    calculators: [
      ...
      },
      {
        id: 'hra',
        name: 'HRA Exemption',
        description: 'House Rent Allowance relief',
      },
      {
        id: 'salary',
        name: 'Salary Calculator',
        description: 'CTC to in-hand breakdown',
      },
      {
        id: 'gratuity',
        name: 'Gratuity',
        description: 'End-of-service entitlement',
      },
      {
        id: 'gst',
        name: 'GST Calculator',
        description: 'Inclusive and exclusive GST',
      },
      {
        id: 'tds',
        name: 'TDS Calculator',
    ...
    calculators: [
      {
        id: 'brokerage',
        name: 'Brokerage',
        description: 'All-in cost of a trade',
      },
    ...
    calculators: [
      {
        id: 'retirement',
        name: 'Retirement',
        description: 'Corpus for your later years',
      },
    ],
  },
];
        ...
        <div className='grid lg:grid-cols-[1fr_auto] gap-6 lg:gap-10 items-end'>
          <div>
            ...
            <p className='mt-4 font-serif italic text-[18px] text-muted-foreground leading-snug max-w-xl'>
              A working set of {TOTAL} instruments — for the patient saver, the
              careful borrower, and the disciplined investor.
            </p>
          </div>
          ...
          <div className='text-left lg:text-right space-y-1 lg:pl-8 lg:border-l border-hairline'>
            ...
            <p
              className='font-serif italic text-[15px] text-foreground'
            ...
            <div className='pt-2 flex lg:justify-end items-center gap-2 text-[10px] uppercase tracking-[0.22em] text-muted-foreground'>
              ...
              <span>
                {TOTAL} entries · {CATEGORIES.length} sections
              </span>
            </div>
          </div>
        </div>
      ...
      <section>
        <div className='grid lg:grid-cols-[1fr_minmax(0,420px)] gap-4 items-baseline'>
          <p className='font-serif italic text-[15px] text-muted-foreground'>
            Search the index by name or by what it computes — for instance,{' '}
            <span className='not-italic font-mono text-foreground'>
              retirement
            </span>
            , <span className='not-italic font-mono text-foreground'>EMI</span>,{' '}
            <span className='not-italic font-mono text-foreground'>GST</span>.
          </p>
        ...
        {search && (
          <p className='mt-3 text-[11px] font-mono text-muted-foreground'>
            {matchCount} {matchCount === 1 ? 'entry' : 'entries'} matching “
            {search}”
          </p>
        )}
      </section>
            ...
            <section key={category.id} className='space-y-5'>
              <div className='flex items-baseline justify-between gap-4 border-b border-hairline pb-3'>
                <div className='flex items-baseline gap-3 min-w-0'>
                  ...
                  <div className='min-w-0'>
                    ...
                    <h2 className='font-serif text-[26px] sm:text-[30px] leading-none tracking-tight text-foreground flex items-baseline gap-2.5 mt-1'>
                      <Icon
                        size={16}
                        className='text-muted-foreground translate-y-0.5'
                        aria-hidden='true'
                      />
                ...
                <p className='font-mono text-[11px] text-muted-foreground whitespace-nowrap'>
                  ...
                  {category.calculators.length === 1 ? 'entry' : 'entries'}
                </p>
              </div>
      ...
      <section className='border-t border-hairline pt-8'>
        <div className='border-l-2 border-foreground/70 pl-5 max-w-3xl mx-auto'>
          ...
          <p className='font-serif italic text-[15px] text-muted-foreground leading-snug'>
            All figures are produced for reference only. Tax brackets, scheme
            rates, and market assumptions change; verify with a qualified
            adviser before acting on any number you find here.
          </p>
        </div>
      </section>
    </article>
