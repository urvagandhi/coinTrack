          ...
          <div className='grid grid-cols-2 gap-2'>
            {transactionTypes.map(type => (
              <button
                ...
                type='button'
                onClick={() =>
                  setInputs(prev => ({ ...prev, transactionType: type.id }))
                }
          ...
          <div className='space-y-6'>
            <div className='grid grid-cols-2 gap-4'>
              <div className='text-center p-3 bg-green-50 dark:bg-green-900/20 rounded-lg'>
                ...
                <p
                  className={`text-xl font-bold ${result.grossPnl >= 0 ? 'text-green-600' : 'text-red-600'}`}
                >
              ...
              <div className='text-center p-3 bg-primary/10 rounded-lg'>
                ...
                <p
                  className={`text-xl font-bold ${result.netPnl >= 0 ? 'text-green-600' : 'text-red-600'}`}
                >
            ...
            <div className='space-y-2 text-sm'>
              ...
              <div className='flex justify-between p-2 rounded hover:bg-muted/50'>
                ...
                <span className='font-medium'>
                  {formatCurrency(result.exchangeCharges)}
                </span>
              </div>
              <div className='flex justify-between p-2 rounded hover:bg-muted/50'>
                <span>GST (18%)</span>
            ...
            <div className='grid grid-cols-2 gap-4'>
              ...
              <ResultMetric
                ...
                value={formatPercentage(
                  (result.totalCharges / result.turnover) * 100
                )}
