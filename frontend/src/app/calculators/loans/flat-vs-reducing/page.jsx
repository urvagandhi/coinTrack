            ...
            <div className='space-y-5'>
              ...
              <div className='grid grid-cols-2 gap-3'>
                <ComparisonPanel
                  ...
                  items={[
                    ...
                    {
                      label: 'Interest',
                      value: formatCurrency(result.flatTotalInterest),
                    },
                    {
                      label: 'Total',
                      value: formatCurrency(result.flatTotalPayment),
                    },
                  ]}
                />
                <ComparisonPanel
                  ...
                  items={[
                    ...
                    {
                      label: 'Interest',
                      value: formatCurrency(result.reducingTotalInterest),
                    },
                    {
                      label: 'Total',
                      value: formatCurrency(result.reducingTotalPayment),
                    },
                  ]}
                />
              </div>
              ...
              <div className='border-l-2 border-foreground/70 pl-4 py-1'>
                ...
                <p className='font-serif italic text-[14px] text-muted-foreground leading-snug'>
                  ...
                  flat rate is equivalent to about{' '}
                  <span className='not-italic font-mono text-foreground tabular-nums'>
