            ...
            {[
              ...
              return (
                <Link
                  key={item.label}
                  href={item.href}
                  className={`px-3 py-1.5 text-[12px] uppercase tracking-[0.18em] transition-colors ${
                    active
                      ? 'text-foreground'
            ...
            <div className='sm:col-span-1'>
              <Link href='/' className='flex items-center gap-2 mb-3'>
                ...
                <span className='flex items-baseline gap-0.5'>
                  ...
                  <span className='display-serif italic text-[22px] leading-none text-[hsl(var(--accent))]'>
                    Track
                  </span>
                </span>
              </Link>
              ...
              <ul className='space-y-2 text-[13px] text-muted-foreground'>
                ...
                <li>
                  <button
                    ...
                    className='font-serif hover:text-foreground transition-colors text-left'
                  >
                    Contact
                  </button>
                </li>
