  ...
  return (
    <div
      className={cn(
        ...
        recommended
          ? 'border-[hsl(var(--gain))] border-l-[3px]'
          : 'border-hairline'
      )}
    >
      ...
      <div className='space-y-2'>
        {items.map(it => (
          <div key={it.label}>
            ...
            <p className='font-mono tabular-nums text-[13px] text-foreground mt-0.5'>
              {it.value}
            </p>
          </div>
        ))}
              ...
              <div className='grid grid-cols-2 gap-3'>
                  ...
                  items={[
                    {
                      ...
                      value: formatCurrency(result.taxableIncomeOldRegime),
                    },
                    {
                      label: 'Tax',
                      value: formatCurrency(result.taxOldRegime),
                    },
                    {
                      label: 'Cess (4%)',
                      value: formatCurrency(result.cessOldRegime),
                    },
                  ]}
                ...
                <RegimePanel
                  ...
                  items={[
                    {
                      label: 'Taxable Income',
                      value: formatCurrency(result.taxableIncomeNewRegime),
                    },
                    {
                      label: 'Tax',
                      value: formatCurrency(result.taxNewRegime),
                    },
                    {
                      label: 'Cess (4%)',
                      value: formatCurrency(result.cessNewRegime),
                    },
                  ]}
