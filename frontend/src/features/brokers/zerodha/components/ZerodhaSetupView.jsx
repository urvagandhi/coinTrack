...
export function ZerodhaSetupView() {
          ...
          {isConnected ? (
            <>
              ...
              <button
                ...
                className='ed-btn ed-btn-ghost w-full'
              >
                {isConnecting ? (
                  <>
            ...
            <>
              ...
              <p className='text-[11.5px] text-muted-foreground font-serif italic leading-relaxed'>
                You will be redirected to Zerodha Kite. After successful login,
                Zerodha returns you here automatically.
              </p>
              <button
                onClick={handleConnect}
                disabled={isConnecting}
            ...
            <>
              ...
              <button
                ...
                disabled={
                  !form.apiKey.trim() || !form.apiSecret.trim() || isSaving
                }
                className='ed-btn ed-btn-primary w-full'
              >
                {isSaving ? (
...
export default ZerodhaSetupView;
