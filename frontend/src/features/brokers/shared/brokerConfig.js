    ...
    setupSteps: [
      {
        ...
        link: {
          label: 'Open Kite Developer Portal',
  ...
  ANGEL_ONE: {
    ...
    credentialFields: [
      ...
      },
      {
        ...
        sensitive: true,
        helpText:
          'NOT your 6-digit OTP. The 32-char seed shown when setting up TOTP at smartapi.angelbroking.com',
      },
    ],
    setupSteps: [
      {
  ...
  UPSTOX: {
    ...
    credentialFields: [
      ...
      },
      {
        ...
        sensitive: false,
        helpText:
          'Must exactly match the redirect URL set in your Upstox developer app',
      },
    ],
    setupSteps: [
      {
        ...
        link: {
          label: 'Open Upstox Developer Console',
...
export const getBrokerByKey = key =>
  BROKER_LIST.find(b => b.key === key) ?? null;
