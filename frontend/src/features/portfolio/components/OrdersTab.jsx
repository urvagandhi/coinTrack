...
import { usePortfolioOrders } from '@/features/portfolio';
            ...
            <table className='ed-table'>
              ...
              <tbody>
                {orders.map((o, i) => {
                  ...
                  const dateStr =
                    o.orderTimestamp || o.order_timestamp || o.placedAt;
                  ...
                  return (
                    <tr key={o.orderId || o.order_id || i}>
                      ...
                      <td className='font-medium text-foreground tracking-tight'>
                      ...
                      <td className='text-right font-mono tnum'>
                        {formatCurrency(o.price ?? o.averagePrice)}
                      </td>
                      ...
                      <td className='text-right pr-6 font-mono text-[10px] text-muted-foreground/70'>
