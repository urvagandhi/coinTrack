...
export default function OverrideUnitsModal({
  isOpen,
  onClose,
  scheme,
  onSuccess,
  ...
  const [units, setUnits] = useState(
    scheme?.manualTotalUnits || scheme?.totalUnit || ''
  );
        ...
        <form onSubmit={handleSubmit} className='p-5 space-y-4'>
          ...
          <div className='space-y-1.5 pt-2'>
            <label className='eyebrow'>
              Manual Total Units (Option 3 Override)
            </label>
            <input
              type='number'
              step='any'
            ...
            <p className='text-[11px] text-muted-foreground leading-relaxed mt-1'>
              Enter your current total units directly from your broker app. This
              overrides calculated units for redemptions & holdings summary.
              Leave empty to restore auto-calculated units.
            </p>
          </div>
