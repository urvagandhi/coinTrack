...
function autoExtractCategory(name) {
  ...
  if (lower.includes('large cap') || lower.includes('bluechip'))
    return 'Large Cap';
  ...
  if (lower.includes('balanced') || lower.includes('advantage'))
  ...
  if (lower.includes('fund of fund') || lower.includes('fof'))
  ...
  const handleSubmit = async e => {
    ...
    try {
      if (initialData?.id || initialData?.schemeId) {
        await mutualFundAPI.updateScheme(
          initialData.id || initialData.schemeId,
          formData
        );
        toast({
          title: 'Success',
      ...
      toast({
        title: 'Error',
        description: 'Failed to save scheme. Check console for details.',
        variant: 'destructive',
      });
    } finally {
      setLoading(false);
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5'>
              ...
              <div className='space-y-1.5'>
                ...
                <CategoryDropdown
                  ...
                  onChange={cat =>
                    setFormData({ ...formData, mfCategory: cat })
                  }
      ...
      <Dialog open={showDeleteConfirm} onOpenChange={setShowDeleteConfirm}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete this scheme? All associated
              lumpsums and SIPs will be deleted! This action cannot be undone.
            </DialogDescription>
          </DialogHeader>
