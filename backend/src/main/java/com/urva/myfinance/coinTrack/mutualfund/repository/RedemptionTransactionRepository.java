...
public interface RedemptionTransactionRepository
    extends MongoRepository<RedemptionTransaction, String> {
  ...
  List<RedemptionTransaction> findByUserIdAndSchemeIdAndRedemptionDateAfterOrderByRedemptionDateAsc(
      String userId, String schemeId, LocalDate date);

  List<RedemptionTransaction> findByUserIdAndSchemeIdAndRedemptionDateAfter(
      String userId, String schemeId, LocalDate date);

  List<RedemptionTransaction> findByUserIdAndRedemptionDateBetween(
