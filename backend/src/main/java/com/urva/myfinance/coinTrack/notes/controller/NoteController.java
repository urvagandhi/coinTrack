...
/**
 * REST controller for note management. Uses Principal from SecurityContext for user identification.
 *
 * <p>GET /api/notes supports pagination: ?page=0&size=20&search=keyword&tag=Strategy Frontend can
 * ignore these params and get paginated results (default page=0, size=20).
 */
@RestController
...
public class NoteController {
  ...
  public ResponseEntity<?> getAllNotes(
    ...
    logger.debug(
        "Getting notes for user: {}, page={}, size={}, search={}, tag={}",
    ...
    Page<Note> notes =
        noteService.getNotesPaginated(principal.getUserId(), page, size, search, tag);
  ...
  public ResponseEntity<?> createNote(
      @Valid @RequestBody NoteRequest request, @AuthenticationPrincipal UserPrincipal principal) {
