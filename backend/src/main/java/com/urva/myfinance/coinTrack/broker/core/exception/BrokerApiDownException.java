...
/**
 * Thrown when the broker API is unreachable — 5xx errors, connection timeouts, or DNS failures.
 *
 * <p>Triggers: fall back to last cached canonical data from MongoDB, mark broker as stale.
 */
@Getter
