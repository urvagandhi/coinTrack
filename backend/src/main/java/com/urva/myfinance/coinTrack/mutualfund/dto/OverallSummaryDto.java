...
public class OverallSummaryDto {
  ...
  public void setOverallPL(BigDecimal overallPL) {
  ...
  public void setDiscrepancies(List<DiscrepancyReport> discrepancies) {
  ...
  public static class DiscrepancyReport {
    ...
    public BigDecimal getSnapshotInvestmentValue() {
      return snapshotInvestmentValue;
    }

    public void setSnapshotInvestmentValue(BigDecimal snapshotInvestmentValue) {
      this.snapshotInvestmentValue = snapshotInvestmentValue;
    }

    public BigDecimal getLedgerTotalInvestment() {
      return ledgerTotalInvestment;
    }

    public void setLedgerTotalInvestment(BigDecimal ledgerTotalInvestment) {
      this.ledgerTotalInvestment = ledgerTotalInvestment;
    }
