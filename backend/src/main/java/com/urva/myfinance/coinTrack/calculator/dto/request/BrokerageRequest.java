...
public record BrokerageRequest(
    @NotNull(message = "Transaction type is required")
        String transactionType, // DELIVERY, INTRADAY, FUTURES,
    // OPTIONS
    ...
    @NotNull(message = "Sell price is required")
        @DecimalMin(value = "0.01", message = "Sell price must be positive")
        BigDecimal sellPrice,
    @NotNull(message = "Quantity is required")
        @DecimalMin(value = "1", message = "Minimum quantity is 1")
        @DecimalMax(value = "10000000", message = "Maximum quantity is 1 crore")
        BigDecimal quantity,
