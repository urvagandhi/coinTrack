...
public class HomeController {
  ...
  public String home() {
    ...
    sb.append(
        "body{font-family:'Segoe UI',Tahoma,Geneva,Verdana,sans-serif;background-color:#f4f7f6;margin:0;padding:0;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100vh;text-align:center;} ");
    sb.append("img{max-width:250px;margin-bottom:30px;} ");
    sb.append("h1{font-size:2.5rem;color:#2c3e50;margin:0 0 15px 0;} ");
    sb.append(
        ".description{max-width:600px;color:#555;font-size:1.1rem;line-height:1.6;margin:0 auto 20px auto;} ");
    sb.append("p{color:#7f8c8d;font-size:1.2rem;margin:0 0 40px 0;} ");
    sb.append(
        ".btn{display:inline-block;padding:12px 30px;background-color:#007bff;color:#fff;text-decoration:none;border-radius:30px;font-size:1.1rem;font-weight:600;transition:all 0.2s;margin:0 10px;} ");
    sb.append(
        ".btn:hover{background-color:#0056b3;transform:translateY(-2px);box-shadow:0 4px 10px rgba(0,123,255,0.3);} ");
