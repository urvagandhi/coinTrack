 ...
 *
 * <p>Zerodha quirks: - Response has equity and commodity segments — we only use the equity segment
 * - Commodity segment may be null entirely - Nested structure: equity.available.cash,
 * equity.utilised.debits, etc.
 */
@Component
public class ZerodhaFundsMapper {
  ...
  public CanonicalFunds toCanonical(ZerodhaFundsRaw raw, String userId, String brokerAccountId) {
    ...
    if (equity != null) {
      ...
      log.warn(
          "Zerodha funds response has null equity segment for brokerAccountId={}", brokerAccountId);
    }
