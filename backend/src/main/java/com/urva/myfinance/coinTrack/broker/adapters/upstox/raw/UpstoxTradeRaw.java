...
/**
 * Raw trade response from Upstox v2 /order/trades/get-trades-for-day. Prices are Float, quantities
 * are Integer. Timestamps are strings in "yyyy-MM-dd HH:mm:ss" format.
 */
@Data
