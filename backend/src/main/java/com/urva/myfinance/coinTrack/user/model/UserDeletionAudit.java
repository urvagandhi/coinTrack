 ...
 *
 * Industry-standard deletion trail: who was deleted, when, from where,
 * and under what reason/status. The live User document is gone after
 * deletion — this snapshot is the only remaining identity evidence,
 * retained for dispute resolution, fraud investigation, and regulatory
 * audits. It intentionally contains NO credentials and is never served
