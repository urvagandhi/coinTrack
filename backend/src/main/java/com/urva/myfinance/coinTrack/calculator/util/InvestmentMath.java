...
/** Investment calculations (Lumpsum, CAGR, Inflation, Stock Average). Stateless, thread-safe. */
@Component
public class InvestmentMath {
  ...
  /** Calculate Lumpsum Future Value. Formula: FV = P × (1 + r)^n */
  ...
  /**
   * Calculate CAGR. Formula: CAGR = (FV / PV)^(1/n) − 1
   *
  ...
  /** Calculate inflation-adjusted future value. Formula: FV = PV × (1 + inflation)^years */
  public BigDecimal inflationAdjustedFuture(
  ...
  /** Calculate present value given future inflation. Formula: PV = FV / (1 + inflation)^years */
  public BigDecimal inflationAdjustedPresentValue(
  ...
  /**
   * Calculate weighted average price of stocks. Formula: Avg Price = Total Cost / Total Quantity
   */
