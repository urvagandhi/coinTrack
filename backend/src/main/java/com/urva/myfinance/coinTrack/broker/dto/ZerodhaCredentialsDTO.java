...
/**
 * DTO for Zerodha broker credentials. Contains all required fields for Zerodha API integration.
...
public class ZerodhaCredentialsDTO {
  ...
  /**
   * Zerodha API key provided by Zerodha for application access. Required for all Zerodha API calls.
   */
  ...
  /**
   * Zerodha API secret provided by Zerodha for secure authentication. Used for generating access
   * tokens.
   */
  ...
  /**
   * Zerodha client ID (user ID) for the broker account. Typically the user's Zerodha trading
   * account ID.
   */
  ...
  /**
   * Request token received from Zerodha OAuth flow. Used to generate access token for API calls.
   */
  ...
  public String toString() {
    return "ZerodhaCredentialsDTO{"
        + "zerodhaApiKey='"
        + (zerodhaApiKey != null ? "[PROTECTED]" : null)
        + '\''
        + ", zerodhaApiSecret='"
        + (zerodhaApiSecret != null ? "[PROTECTED]" : null)
        + '\''
        + ", clientId='"
        + clientId
        + '\''
        + ", requestToken='"
        + (requestToken != null ? "[PROTECTED]" : null)
        + '\''
        + '}';
  }
}
