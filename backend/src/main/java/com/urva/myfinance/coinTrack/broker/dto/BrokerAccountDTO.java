...
/** DTO for broker account responses. Contains broker account information for API responses. */
...
public class BrokerAccountDTO {
   ...
   */
  public BrokerAccountDTO(
      Long id, Long userId, String brokerName, String clientId, Boolean isConnected) {
    this.id = id;
    this.userId = userId;
