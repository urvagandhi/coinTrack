...
public class MfCategoryHelper {
  ...
  private static final List<String> EQUITY_CATEGORIES =
      Arrays.asList(
          "Large Cap",
          "Large & Mid Cap",
          "Mid Cap",
  ...
  public static boolean isEquityOriented(String category) {
    ...
    if (lowerCat.contains("equity")
        || lowerCat.contains("flexi")
        || lowerCat.contains("small cap")
        || lowerCat.contains("mid cap")
        || lowerCat.contains("large cap")) {
      return true;
    }
