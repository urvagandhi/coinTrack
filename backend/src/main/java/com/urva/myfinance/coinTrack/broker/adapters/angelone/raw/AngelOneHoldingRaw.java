...
/**
 * Raw holding response from Angel One SmartAPI. Per official docs: quantity/t1quantity are int,
 * averageprice/ltp/close/profitandloss are double. isin can be null for SME stocks.
 */
@Data
