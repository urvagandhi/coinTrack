...
public class ZerodhaMfSipRaw {
  ...
  /**
   * Stores the complete raw JSON object received from Zerodha. This ensures forward compatibility
  ...
  public boolean getHasMissedInstalment() {
    if (nextInstalmentDate == null) return false;
    try {
      ...
      if (next.isBefore(today)) {
        ...
        if (lastExecDateStr == null) return true; // Missed and never executed
        return true;
      }
      return false;
    } catch (Exception e) {
