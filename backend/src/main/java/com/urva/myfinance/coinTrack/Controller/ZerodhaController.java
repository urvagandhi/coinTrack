...
@RestController
@RequestMapping("/api/brokers/zerodha")
public class ZerodhaController {
    ...
    public ResponseEntity<?> getZerodhaLoginUrl(@RequestParam String appUserId) {
        try {
            ...
            // set to http://localhost:8080/api/brokers/zerodha/callback
            ...
            // comment above)
            // String callbackUrl =
            // java.net.URLEncoder.encode("http://localhost:8080/api/brokers/zerodha/callback?appUserId="
            // + appUserId, "UTF-8");
     ...
     * 2. Edit your app
     * 3. Set Redirect URL to: http://localhost:8080/api/brokers/zerodha/callback
     * 4. For production, use: https://yourdomain.com/api/brokers/zerodha/callback
     */
    @GetMapping("/callback")
    ...
    private final ZerodhaServiceImpl zerodhaService;
    private final UserService userService;

    public ZerodhaController(ZerodhaServiceImpl zerodhaService, UserService userService) {
