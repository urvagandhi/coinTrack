...
public class LumpsumTransactionController {
  ...
  @Autowired private LumpsumTransactionService service;
  ...
  public ResponseEntity<ApiResponse<List<LumpsumTransaction>>> getTransactions(
    ...
    List<LumpsumTransaction> transactions =
        service.getTransactions(userDetails.getUserId(), schemeId);
    return ResponseEntity.ok(
        ApiResponse.success(transactions, "Fetched transactions successfully"));
  }
  ...
  public ResponseEntity<ApiResponse<Page<LumpsumTransaction>>> getPaginatedTransactions(
    ...
    Page<LumpsumTransaction> transactions =
        service.getPaginatedTransactions(userDetails.getUserId(), PageRequest.of(page, size));
    return ResponseEntity.ok(
        ApiResponse.success(transactions, "Fetched paginated transactions successfully"));
  }
  ...
  public ResponseEntity<ApiResponse<List<LumpsumTransaction>>> getTransactionsByDateRange(
    ...
    List<LumpsumTransaction> transactions =
        service.getTransactionsByDateRange(userDetails.getUserId(), startDate, endDate);
    return ResponseEntity.ok(
        ApiResponse.success(transactions, "Fetched transactions by date range successfully"));
  }

  @GetMapping("/financial-year/{year}")
  public ResponseEntity<ApiResponse<List<LumpsumTransaction>>> getTransactionsByFinancialYear(
      @AuthenticationPrincipal UserPrincipal userDetails, @PathVariable int year) {
    List<LumpsumTransaction> transactions =
        service.getTransactionsByFinancialYear(userDetails.getUserId(), year);
    return ResponseEntity.ok(
        ApiResponse.success(transactions, "Fetched transactions by financial year successfully"));
  }
  ...
  public ResponseEntity<ApiResponse<LumpsumTransaction>> getTransaction(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(transaction, "Fetched lumpsum transaction successfully"));
  }
  ...
  public ResponseEntity<ApiResponse<LumpsumTransaction>> createTransaction(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(created, "Lumpsum transaction created successfully"));
  }
  ...
  public ResponseEntity<ApiResponse<LumpsumTransaction>> updateTransaction(
      ...
      @RequestBody LumpsumTransaction transaction) {
    LumpsumTransaction updated =
        service.updateTransaction(userDetails.getUserId(), id, transaction);
    return ResponseEntity.ok(
        ApiResponse.success(updated, "Lumpsum transaction updated successfully"));
  }
