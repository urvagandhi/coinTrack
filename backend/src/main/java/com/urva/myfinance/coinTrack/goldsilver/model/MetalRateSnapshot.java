...
/**
 * Time-Series collection for historical gold/silver spot prices. MongoDB columnar compression
 * dramatically reduces storage for this append-only feed that grows daily.
 */
...
public class MetalRateSnapshot {
  ...
  private BigDecimal
      baseRatePerGram; // 24K gold / 999 silver spot, converted to INR, BEFORE local premium
