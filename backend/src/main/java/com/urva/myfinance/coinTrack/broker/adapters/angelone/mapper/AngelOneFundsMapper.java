 ...
 *
 * <p>Angel One quirks: - All fields are Strings — parsed via PriceNormalizer - Opening balance is
 * not provided
 */
@Component
public class AngelOneFundsMapper {
  ...
  public CanonicalFunds toCanonical(AngelOneFundsRaw raw, String userId, String brokerAccountId) {
    ...
    BigDecimal totalMargin = PriceNormalizer.toBigDecimal(raw.getNet(), "net", Broker.ANGELONE);
