...
/**
 * Thrown BEFORE any HTTP call is made when a broker does not support the requested capability.
 *
 * <p>Example: calling fetchMfHoldings() on Upstox (no MF API). This replaces the old pattern of
 * silent empty returns or generic UnsupportedOperationException at runtime.
 */
@Getter
