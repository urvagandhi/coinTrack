 ...
 *
 * <p>Angel One quirks: - filltime usually arrives as "HH:mm:ss" (current trading day) — combined
 * with today's date. - Numerics are Strings — routed through PriceNormalizer.
 */
@Component
