...
/**
 * Append-only store for account-deletion audit trails. Rows are written before the User document is
 * destroyed and are never exposed through any controller — compliance/investigation access only.
 */
@Repository
