...
public class SipContributionController {
  ...
  @Autowired private SipContributionService service;
  ...
  public ResponseEntity<ApiResponse<List<SipContribution>>> getContributions(
    ...
    List<SipContribution> contributions =
        service.getContributions(userDetails.getUserId(), schemeId);
    return ResponseEntity.ok(
        ApiResponse.success(contributions, "Fetched SIP contributions successfully"));
  }

  @GetMapping("/mandate/{mandateId}")
  public ResponseEntity<ApiResponse<List<SipContribution>>> getContributionsByMandate(
      @AuthenticationPrincipal UserPrincipal userDetails, @PathVariable String mandateId) {
    List<SipContribution> contributions =
        service.getContributionsByMandate(userDetails.getUserId(), mandateId);
    return ResponseEntity.ok(
        ApiResponse.success(contributions, "Fetched contributions by mandate successfully"));
  }
  ...
  public ResponseEntity<ApiResponse<List<SipContribution>>> getContributionsByDateRange(
    ...
    List<SipContribution> contributions =
        service.getContributionsByDateRange(userDetails.getUserId(), startDate, endDate);
    return ResponseEntity.ok(
        ApiResponse.success(contributions, "Fetched contributions by date range successfully"));
  }
  ...
  public ResponseEntity<ApiResponse<List<SipContribution>>> getContributionsByFinancialYear(
    ...
    List<SipContribution> contributions =
        service.getContributionsByFinancialYear(userDetails.getUserId(), year);
    return ResponseEntity.ok(
        ApiResponse.success(contributions, "Fetched contributions by financial year successfully"));
  }
  ...
  public ResponseEntity<ApiResponse<SipContribution>> getContribution(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(contribution, "Fetched SIP contribution successfully"));
  }
