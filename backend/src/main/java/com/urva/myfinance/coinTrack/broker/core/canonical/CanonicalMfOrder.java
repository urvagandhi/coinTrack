...
/**
 * Canonical MF order — tracks mutual fund buy/sell order history. Currently only Zerodha provides
 * MF orders in this system.
 */
@Document(collection = "canonical_mf_orders")
@CompoundIndexes({
  @CompoundIndex(
      name = "idx_mf_order_unique",
      def = "{'userId': 1, 'brokerAccountId': 1, 'orderId': 1}",
      unique = true)
})
@Builder
@Getter
