...
public class NSEHolidayService {
  ...
  private static final String NSE_HOLIDAY_URL =
  ...
  public void refreshHolidays() {
    try {
      ...
      // NSE requires a valid User-Agent, and often a cookie. First request to homepage gets the
      // cookie.
      ...
      ResponseEntity<String> response =
          restTemplate.exchange(NSE_HOLIDAY_URL, HttpMethod.GET, apiEntity, String.class);
