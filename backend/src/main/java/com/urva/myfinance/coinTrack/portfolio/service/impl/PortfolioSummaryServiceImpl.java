...
/**
 * Orchestrator — delegates to HoldingEnricher, PositionEnricher, PortfolioTotalsCalculator. Reduced
 * from 953 lines to ~120 lines of orchestration + MF pass-through methods.
 *
 * <p>Changed: Extracted P&L computation into HoldingEnricher, PositionEnricher,
 * PortfolioTotalsCalculator. Added hasStalePrices flag to response.
 */
@Service
public class PortfolioSummaryServiceImpl implements PortfolioSummaryService {
  ...
  private final com.urva.myfinance.coinTrack.broker.repository.BrokerAccountRepository
      brokerAccountRepository;
  private final com.urva.myfinance.coinTrack.broker.service.ZerodhaLiveDataService
      zerodhaLiveDataService;
  private final com.urva.myfinance.coinTrack.broker.adapters.upstox.UpstoxBrokerAdapter
      upstoxBrokerAdapter;
  private final com.urva.myfinance.coinTrack.broker.adapters.angelone.AngelOneBrokerAdapter
      angelOneBrokerAdapter;
  private final com.urva.myfinance.coinTrack.portfolio.repository.CanonicalFundsRepository
      canonicalFundsRepository;
  private final com.urva.myfinance.coinTrack.portfolio.repository.CanonicalMfOrderRepository
      canonicalMfOrderRepository;

  @Autowired
  public PortfolioSummaryServiceImpl(
      ...
      com.urva.myfinance.coinTrack.broker.repository.BrokerAccountRepository
          brokerAccountRepository,
      ...
      com.urva.myfinance.coinTrack.broker.adapters.angelone.AngelOneBrokerAdapter
          angelOneBrokerAdapter,
      com.urva.myfinance.coinTrack.portfolio.repository.CanonicalFundsRepository
          canonicalFundsRepository,
      com.urva.myfinance.coinTrack.portfolio.repository.CanonicalMfOrderRepository
          canonicalMfOrderRepository) {
  ...
  public PortfolioSummaryResponse getPortfolioSummary(String userId) {
    ...
    boolean hasStalePrices =
        priceMap.values().stream()
            .anyMatch(
                mp ->
                    mp.getUpdatedAt() != null
                        && java.time.Duration.between(mp.getUpdatedAt(), LocalDateTime.now())
                                .getSeconds()
                            > 60);
  ...
  private LocalDateTime getLatestSyncTime(String userId) {
    Optional<SyncLog> lastLog =
        syncLogRepository.findFirstByUserIdAndStatusOrderByTimestampDesc(
            userId, SyncStatus.SUCCESS);
  ...
  @Override
  public com.urva.myfinance.coinTrack.portfolio.dto.kite.KiteListResponse<
          com.urva.myfinance.coinTrack.portfolio.dto.kite.OrderDTO>
      getOrders(String userId) {
    List<com.urva.myfinance.coinTrack.broker.model.BrokerAccount> accounts =
        brokerAccountRepository.findByUserId(userId);
    ...
    for (com.urva.myfinance.coinTrack.broker.model.BrokerAccount account : accounts) {
      ...
      try {
        ...
        } else if (account.getBroker()
            == com.urva.myfinance.coinTrack.broker.model.Broker.ANGELONE) {
    ...
    com.urva.myfinance.coinTrack.portfolio.dto.kite.KiteListResponse<
            com.urva.myfinance.coinTrack.portfolio.dto.kite.OrderDTO>
        response = new com.urva.myfinance.coinTrack.portfolio.dto.kite.KiteListResponse<>();
  ...
  @Override
  public com.urva.myfinance.coinTrack.portfolio.dto.kite.KiteListResponse<
          com.urva.myfinance.coinTrack.portfolio.dto.kite.TradeDTO>
      getTrades(String userId) {
    List<com.urva.myfinance.coinTrack.broker.model.BrokerAccount> accounts =
        brokerAccountRepository.findByUserId(userId);
  ...
  private void persistCanonicalFunds(
      String userId,
    ...
    try {
      ...
      var canonicalFunds =
          com.urva
              ...
              .availableCash(
                  available != null && available.getCash() != null
                      ? available.getCash()
                      : BigDecimal.ZERO)
              .usedMargin(
                  utilised != null && utilised.getDebits() != null
                      ? utilised.getDebits()
                      : BigDecimal.ZERO)
              .totalMargin(
                  equity != null && equity.getNet() != null ? equity.getNet() : BigDecimal.ZERO)
      ...
      canonicalFundsRepository
          .findByUserIdAndBrokerAccountId(userId, account.getId())
  ...
  @Override
  public com.urva.myfinance.coinTrack.portfolio.dto.kite.KiteListResponse<
          com.urva.myfinance.coinTrack.portfolio.dto.kite.MutualFundDTO>
      getMutualFunds(String userId) {
    List<com.urva.myfinance.coinTrack.broker.model.BrokerAccount> accounts =
        brokerAccountRepository.findByUserId(userId);
  ...
  @Override
  public com.urva.myfinance.coinTrack.portfolio.dto.kite.KiteListResponse<
          com.urva.myfinance.coinTrack.portfolio.dto.kite.MutualFundOrderDTO>
      getMfOrders(String userId) {
    List<com.urva.myfinance.coinTrack.broker.model.BrokerAccount> accounts =
        brokerAccountRepository.findByUserId(userId);
    List<com.urva.myfinance.coinTrack.portfolio.dto.kite.MutualFundOrderDTO> allOrders =
        new ArrayList<>();
    LocalDateTime syncTime = LocalDateTime.now();
    ...
    for (com.urva.myfinance.coinTrack.broker.model.BrokerAccount account : accounts) {
      if (account.getBroker() == com.urva.myfinance.coinTrack.broker.model.Broker.ZERODHA
          && account.hasValidToken()) {
        try {
          List<com.urva.myfinance.coinTrack.portfolio.dto.kite.MutualFundOrderDTO> orders =
              zerodhaLiveDataService.fetchMfOrders(account);
          for (com.urva.myfinance.coinTrack.portfolio.dto.kite.MutualFundOrderDTO order : orders) {
            try {
              ...
              canonicalMfOrderRepository
                  .findByUserIdAndBrokerAccountIdAndOrderId(
  ...
  public KiteListResponse<MfSipDTO> getMfSips(String userId) {
    ...
    Map<String, List<com.urva.myfinance.coinTrack.portfolio.dto.kite.MutualFundOrderDTO>>
        ordersBySipId =
            allOrders.stream()
                .filter(
                    o ->
                ...
                .collect(
                    java.util.stream.Collectors.groupingBy(
                        o -> o.getRaw().get("instruction_id").toString()));

    Set<String> linkedSipIds = new HashSet<>();
    for (MfSipDTO sip : allSips) {
      List<com.urva.myfinance.coinTrack.portfolio.dto.kite.MutualFundOrderDTO> executions =
          ordersBySipId.getOrDefault(sip.getSipId(), new ArrayList<>());
      executions.sort(
          (o1, o2) -> {
            String t1 =
                o1.getExecutionDate() != null ? o1.getExecutionDate() : o1.getOrderTimestamp();
            String t2 =
                o2.getExecutionDate() != null ? o2.getExecutionDate() : o2.getOrderTimestamp();
            if (t1 == null) return -1;
            if (t2 == null) return 1;
    ...
    List<com.urva.myfinance.coinTrack.portfolio.dto.kite.MutualFundOrderDTO> unlinkedOrders =
        new ArrayList<>();
    ordersBySipId.forEach(
        (sipId, orders) -> {
  ...
  @Override
  public com.urva.myfinance.coinTrack.portfolio.dto.kite.KiteListResponse<
          com.urva.myfinance.coinTrack.portfolio.dto.kite.MfTimelineEvent>
      getMfTimeline(String userId) {
    List<com.urva.myfinance.coinTrack.broker.model.BrokerAccount> accounts =
        brokerAccountRepository.findByUserId(userId);
    List<com.urva.myfinance.coinTrack.portfolio.dto.kite.MutualFundOrderDTO> allOrders =
        new ArrayList<>();
    List<com.urva.myfinance.coinTrack.portfolio.dto.kite.MfSipDTO> allSips = new ArrayList<>();
    List<com.urva.myfinance.coinTrack.portfolio.dto.kite.MutualFundDTO> allHoldings =
        new ArrayList<>();
    LocalDateTime syncTime = LocalDateTime.now();
    ...
    List<com.urva.myfinance.coinTrack.portfolio.dto.kite.MfTimelineEvent> events =
        new ArrayList<>();
    Map<String, com.urva.myfinance.coinTrack.portfolio.dto.kite.MfSipDTO> sipMap =
        allSips.stream()
            .collect(
                java.util.stream.Collectors.toMap(
                    com.urva.myfinance.coinTrack.portfolio.dto.kite.MfSipDTO::getSipId,
                    s -> s,
                    (s1, s2) -> s1));
    ...
    for (com.urva.myfinance.coinTrack.portfolio.dto.kite.MutualFundOrderDTO order : allOrders) {
      ...
      BigDecimal qty =
          order.getExecutedQuantity() != null ? order.getExecutedQuantity() : BigDecimal.ZERO;

      if (qty.compareTo(BigDecimal.ZERO) > 0) {
        boolean isBuy =
            "BUY".equalsIgnoreCase(order.getTransactionType())
                || "PURCHASE".equalsIgnoreCase(order.getTransactionType());
        boolean isSell =
            "SELL".equalsIgnoreCase(order.getTransactionType())
      ...
      if (sip.getCreated() != null) {
        ...
        events.add(
            com.urva
                ...
                .tradingSymbol(ts)
                .amount(
                    sip.getInstalmentAmount() != null
                        ? BigDecimal.valueOf(sip.getInstalmentAmount())
                        : null)
                .sipId(sip.getSipId())
                .source("SIP_SETUP")
                .confidence("CONFIRMED")
