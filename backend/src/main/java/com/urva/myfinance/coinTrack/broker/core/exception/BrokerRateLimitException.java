 ...
 *
 * <p>Zerodha: HTTP 429 Angel One: HTTP 200 with errorcode "RR" Upstox: HTTP 429, also tracked via
 * X-RateLimit-Remaining header
 *
 * <p>Triggers: fall back to last cached canonical data from MongoDB.
 */
@Getter
