...
/**
 * REST Controller for Savings Scheme Calculators. All endpoints are public (no authentication
...
@Validated
@Tag(
    name = "Calculators — Savings",
    description = "PPF, EPF, FD, RD, SSY, NPS, NSC, SCSS, MIS, APY")
public class SavingsCalculatorController {
  ...
  /** Calculate PPF maturity. POST /api/calculators/savings/ppf */
  @Operation(summary = "Calculate PPF maturity amount")
  @PostMapping("/ppf")
  public ResponseEntity<CalculatorResponse<PpfResponse>> calculatePpf(
      @Valid @RequestBody PpfRequest request, @RequestParam(defaultValue = "false") boolean debug) {

    logger.info(
        "PPF calculation: yearly={}, years={}", request.yearlyInvestment(), request.years());
    return ResponseEntity.ok(savingsService.calculatePpf(request, debug));
  }

  /** Calculate EPF maturity. POST /api/calculators/savings/epf */
  @Operation(summary = "Calculate EPF maturity amount")
  @PostMapping("/epf")
  public ResponseEntity<CalculatorResponse<EpfResponse>> calculateEpf(
      @Valid @RequestBody EpfRequest request, @RequestParam(defaultValue = "false") boolean debug) {

    logger.info(
        "EPF calculation: basic={}, age={}", request.monthlyBasicSalary(), request.currentAge());
    return ResponseEntity.ok(savingsService.calculateEpf(request, debug));
  }

  /** Calculate FD maturity. POST /api/calculators/savings/fd */
  @Operation(summary = "Calculate Fixed Deposit maturity amount")
  @PostMapping("/fd")
  public ResponseEntity<CalculatorResponse<FdResponse>> calculateFd(
      @Valid @RequestBody FdRequest request, @RequestParam(defaultValue = "false") boolean debug) {

    logger.info(
        "FD calculation: principal={}, rate={}%, days={}",
  ...
  /** Calculate RD maturity. POST /api/calculators/savings/rd */
  ...
  public ResponseEntity<CalculatorResponse<RdResponse>> calculateRd(
      @Valid @RequestBody RdRequest request, @RequestParam(defaultValue = "false") boolean debug) {

    logger.info(
        "RD calculation: monthly={}, rate={}%, months={}",
  ...
  /** Calculate SSY maturity. POST /api/calculators/savings/ssy */
  ...
  public ResponseEntity<CalculatorResponse<SsyResponse>> calculateSsy(
      @Valid @RequestBody SsyRequest request, @RequestParam(defaultValue = "false") boolean debug) {

    logger.info(
        "SSY calculation: yearly={}, girlAge={}", request.yearlyInvestment(), request.girlAge());
    return ResponseEntity.ok(savingsService.calculateSsy(request, debug));
  }

  /** Calculate NPS corpus and pension. POST /api/calculators/savings/nps */
  @Operation(summary = "Calculate NPS corpus and pension")
  @PostMapping("/nps")
  public ResponseEntity<CalculatorResponse<NpsResponse>> calculateNps(
      @Valid @RequestBody NpsRequest request, @RequestParam(defaultValue = "false") boolean debug) {

    logger.info(
        "NPS calculation: monthly={}, currentAge={}, retireAge={}",
  ...
  /** Calculate NSC maturity. POST /api/calculators/savings/nsc */
  ...
  public ResponseEntity<CalculatorResponse<NscResponse>> calculateNsc(
      @Valid @RequestBody NscRequest request, @RequestParam(defaultValue = "false") boolean debug) {
  ...
  /** Calculate SCSS maturity. POST /api/calculators/savings/scss */
  ...
  /** Calculate PO MIS. POST /api/calculators/savings/mis */
  ...
  public ResponseEntity<CalculatorResponse<MisResponse>> calculateMis(
      @Valid @RequestBody MisRequest request, @RequestParam(defaultValue = "false") boolean debug) {
  ...
  /** Calculate APY pension. POST /api/calculators/savings/apy */
  ...
  public ResponseEntity<CalculatorResponse<ApyResponse>> calculateApy(
      @Valid @RequestBody ApyRequest request, @RequestParam(defaultValue = "false") boolean debug) {

    logger.info(
        "APY calculation: pension={}, age={}", request.desiredPension(), request.currentAge());
