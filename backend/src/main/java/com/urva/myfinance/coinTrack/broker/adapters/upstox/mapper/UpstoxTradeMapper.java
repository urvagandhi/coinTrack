...
/**
 * Maps Upstox /order/trades/get-trades-for-day rows to the shared Kite-flavored TradeDTO. Prefers
 * exchange_timestamp over order_timestamp for trade_timestamp (matches Zerodha semantics).
 */
@Component
public class UpstoxTradeMapper {
  ...
  public TradeDTO toKite(UpstoxTradeRaw raw) {
    ...
    String ts =
        raw.getExchangeTimestamp() != null ? raw.getExchangeTimestamp() : raw.getOrderTimestamp();
