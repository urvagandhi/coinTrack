...
/**
 * Sync safety with MongoDB-backed cooldowns + in-memory locks. Changed: 5-min cooldown replaced
 * from ConcurrentHashMap → MongoDB SyncCooldown with TTL. Now survives restarts and works across
 * multiple instances.
 */
@Service
