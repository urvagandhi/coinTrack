 ...
 *
 * <p>Supports two authentication methods: 1. Manual TOTP: Provide 6-digit TOTP code directly in
 * 'totp' field 2. Auto TOTP: Provide Base32-encoded 'totpSecret' for automatic code generation
 *
 * <p>If both are provided, 'totp' takes precedence for that request. If only 'totpSecret' is
 * provided, TOTP will be generated automatically on each connection.
 *
