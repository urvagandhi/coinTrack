...
public class RedemptionTransactionController {
  ...
  @Autowired private RedemptionTransactionService service;
  ...
  public ResponseEntity<ApiResponse<List<RedemptionTransaction>>> getTransactions(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(transactions, "Fetched redemption transactions successfully"));
  }
  ...
  public ResponseEntity<ApiResponse<List<RedemptionTransaction>>> getTransactionsByDateRange(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            transactions, "Fetched redemption transactions by date range successfully"));
  }
  ...
  public ResponseEntity<ApiResponse<List<RedemptionTransaction>>> getTransactionsByFinancialYear(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            transactions, "Fetched redemption transactions by financial year successfully"));
  }
  ...
  public ResponseEntity<ApiResponse<RedemptionTransaction>> getTransaction(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(transaction, "Fetched redemption transaction successfully"));
  }
  ...
  public ResponseEntity<ApiResponse<MfFifoEngine.FifoResult>> previewFifo(
    ...
    MfFifoEngine.FifoResult result =
        service.previewFifo(userDetails.getUserId(), schemeId, date, units);
  ...
  public ResponseEntity<ApiResponse<RedemptionTransaction>> createTransaction(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(created, "Redemption transaction created successfully"));
  }
  ...
  public ResponseEntity<ApiResponse<RedemptionTransaction>> updateTransaction(
      ...
      @RequestBody RedemptionTransaction transaction) {
    RedemptionTransaction updated =
        service.updateTransaction(userDetails.getUserId(), id, transaction);
    return ResponseEntity.ok(
        ApiResponse.success(updated, "Redemption transaction updated successfully"));
  }
  ...
  public ResponseEntity<ApiResponse<Void>> deleteTransaction(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(null, "Redemption transaction deleted successfully"));
  }
}
