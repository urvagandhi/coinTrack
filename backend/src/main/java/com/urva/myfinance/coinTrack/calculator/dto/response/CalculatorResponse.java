...
/**
 * Base response wrapper for all calculator responses. Provides consistent structure with metadata
...
public record CalculatorResponse<T>(
  ...
  public static <T> CalculatorResponse<T> success(
      CalculatorMetadata metadata, T result, List<YearlyBreakdown> breakdown) {
  ...
  public static <T> CalculatorResponse<T> successWithDebug(
      CalculatorMetadata metadata, T result, List<YearlyBreakdown> breakdown, DebugInfo debug) {
  ...
  public static <T> CalculatorResponse<T> error(String code, String message, String field) {
    return new CalculatorResponse<>(
        false, null, null, null, null, new ErrorInfo(code, message, field));
  }
  ...
  public record CalculatorMetadata(
    ...
    public static CalculatorMetadata of(String calculatorId, String category) {
      return new CalculatorMetadata(
          calculatorId, category, "1.0", java.time.LocalDate.now().toString(), List.of());
    }

    public static CalculatorMetadata of(
        String calculatorId, String category, List<String> assumptions) {
      return new CalculatorMetadata(
          calculatorId, category, "1.0", java.time.LocalDate.now().toString(), assumptions);
    }
  }

  /** Year-by-year breakdown for detailed view. */
  public record YearlyBreakdown(
      int year, BigDecimal investment, BigDecimal interest, BigDecimal balance) {}
  ...
  public record DebugInfo(
    ...
    public static DebugInfo withInfo(
        BigDecimal monthlyRate,
        int totalMonths,
        String formula,
