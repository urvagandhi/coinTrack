...
@Tag(
    name = "EPF Settings & Interest Rates",
    description = "EPF user settings and interest rates configuration")
public class EpfSettingsController {
  ...
  @GetMapping("/settings")
  public ResponseEntity<ApiResponse<EpfSettingsResponseDTO>> getSettings(
  ...
  public ResponseEntity<ApiResponse<EpfSettingsResponseDTO>> updateSettings(
    ...
    EpfSettingsResponseDTO updated =
        epfTransactionService.updateSettings(requestDTO, principal.getUserId());
