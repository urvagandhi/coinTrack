...
/**
 * Controller for manual portfolio refresh. Uses Principal from SecurityContext for user
 * identification.
 */
@RestController
...
public class ManualRefreshController {
  ...
  @Autowired
  public ManualRefreshController(
      PortfolioSyncService portfolioSyncService, UserRepository userRepository) {
