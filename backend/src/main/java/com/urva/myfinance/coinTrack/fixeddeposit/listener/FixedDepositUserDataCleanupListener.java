...
public class FixedDepositUserDataCleanupListener {
    ...
    private static final Logger logger = LoggerFactory.getLogger(FixedDepositUserDataCleanupListener.class);
    ...
    public void onUserDeleted(UserDeletedEvent event) {
        try {
            ...
            logger.error("Cascade cleanup failed for fixed deposits, user {}: {}", event.userId(), e.getMessage());
        }
    }
}
