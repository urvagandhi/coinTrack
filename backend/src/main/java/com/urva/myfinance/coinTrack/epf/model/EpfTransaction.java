...
public class EpfTransaction {
  ...
  @Indexed private Long transactionNo;
  ...
  private BigDecimal
      withdrawalAmount; // nullable — from EPF balance only, EPS withdrawal handled separately if
  // ever needed
  private BigDecimal
      epfBalance; // auto-calculated running balance (post-transaction, pre-interest-credit)
  private BigDecimal
      epsBalance; // auto-calculated running balance (post-transaction, pre-interest-credit)
