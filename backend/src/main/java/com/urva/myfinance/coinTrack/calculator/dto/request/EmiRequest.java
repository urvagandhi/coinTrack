...
public record EmiRequest(
    @NotNull(message = "Loan principal is required")
        @DecimalMin(value = "10000", message = "Minimum loan amount is ₹10,000")
        @DecimalMax(value = "1000000000", message = "Maximum loan amount is ₹100 crore")
    ...
    @NotNull(message = "Loan tenure is required")
        ...
        @Max(value = 600, message = "Maximum tenure is 600 months (50 years)")
        Integer months) {}
