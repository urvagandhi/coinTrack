...
/**
 * Base exception for all domain-specific errors in CoinTrack. Provides structured error handling
 * with error codes and HTTP status mapping.
 *
 * <p>Exception Hierarchy: DomainException (base) ├── AuthenticationException (401) ├──
 * AuthorizationException (403) ├── ValidationException (400)
 */
