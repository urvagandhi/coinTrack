 ...
 *
 * <p>Mapping: "NSE", "nse", "NSE_EQ", "NSE_FO" → Exchange.NSE "BSE", "bse", "BSE_EQ" → Exchange.BSE
 * "NFO", "nfo" → Exchange.NFO "MCX", "mcx", "MCX_FO" → Exchange.MCX anything else →
 * Exchange.UNKNOWN + log warning
 *
