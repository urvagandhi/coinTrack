 ...
 *
 * <p>Angel One quirks: - All numerics are Strings — routed through PriceNormalizer. - Timestamps
 * arrive as "dd-MMM-yyyy HH:mm:ss" (e.g. "12-May-2026 14:30:45"); parsed leniently — null on parse
 * failure.
 */
@Component
public class AngelOneOrderMapper {
  ...
  public OrderDTO toKite(AngelOneOrderRaw raw) {
    ...
    dto.setTriggerPrice(
        PriceNormalizer.toBigDecimal(raw.getTriggerprice(), "triggerprice", Broker.ANGELONE));
    ...
    dto.setExchangeTimestamp(
        parseTs(raw.getExchtime() != null ? raw.getExchtime() : raw.getExchorderupdatetime()));
