...
/**
 * Controller for broker connection status. Uses Principal from SecurityContext for user
 * identification.
 */
@RestController
...
public class BrokerStatusController {
  ...
  public BrokerStatusController(
      BrokerStatusService brokerStatusService, UserRepository userRepository) {
  ...
  public ResponseEntity<?> getBrokerStatus(
      Principal principal, @PathVariable("broker") String brokerName) {
