 ...
 *
 * <p>Known formats by broker: Zerodha: "2024-01-15T09:30:00+0530" → ISO_OFFSET_DATE_TIME Angel One:
 * "15-01-2024 09:30" → dd-MM-yyyy HH:mm, assumes Asia/Kolkata Upstox: Long (epoch millis) →
 * Instant.ofEpochMilli(value) OR ISO 8601 String → Instant.parse(value)
 *
 * <p>Returns null for null/empty input — dates are optional on many broker fields. Never throws —
  ...
  public static Instant toInstant(Object value, Broker broker) {
    ...
    try {
      return switch (value) {
        ...
        default -> {
          log.warn(
              "Unexpected date type {} from broker={}, value='{}'",
