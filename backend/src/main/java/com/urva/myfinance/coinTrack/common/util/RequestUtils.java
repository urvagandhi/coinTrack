...
public final class RequestUtils {
  ...
  /**
   * Extract client IP address from HTTP request. Handles: - X-Forwarded-For header (proxy/load
   * balancer) - X-Real-IP header (nginx) - IPv6 loopback conversion to readable format
   *
