...
/** DTO for user login requests. Accepts username, email, or mobile number as login identifier. */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class LoginRequest {

  /**
   * Login identifier - can be username, email, or mobile number. Validated to ensure it's not blank
  ...
  /**
   * User's password for authentication. Validated to ensure it's not blank and meets minimum
