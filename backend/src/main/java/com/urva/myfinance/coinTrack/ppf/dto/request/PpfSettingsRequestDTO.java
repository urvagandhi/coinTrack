...
public class PpfSettingsRequestDTO {
    ...
    @Pattern(regexp = "^[A-Za-z0-9][A-Za-z0-9\\-/ ]*$", message = "accountNumber contains invalid characters")
    private String accountNumber;

    @PastOrPresent(message = "dateOfIssue cannot be in the future")
    private LocalDate dateOfIssue;

    @Pattern(regexp = "^(WITHOUT_CONTRIBUTION|WITH_CONTRIBUTION)$", message = "extensionMode must be WITHOUT_CONTRIBUTION or WITH_CONTRIBUTION")
