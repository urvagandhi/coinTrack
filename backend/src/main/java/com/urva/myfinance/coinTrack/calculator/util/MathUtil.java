...
/**
 * Shared BigDecimal math utilities used by all calculator math classes. Stateless utility class —
 * no instantiation.
 */
public final class MathUtil {
  ...
  /**
   * Power function for BigDecimal with integer exponent. Uses binary exponentiation for efficiency.
   */
