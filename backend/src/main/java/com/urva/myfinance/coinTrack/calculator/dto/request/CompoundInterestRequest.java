...
public record CompoundInterestRequest(
    @NotNull(message = "Principal amount is required")
        @DecimalMin(value = "1000", message = "Minimum principal is ₹1,000")
        @DecimalMax(value = "1000000000", message = "Maximum principal is ₹100 crore")
    ...
    @NotNull(message = "Compounding frequency is required")
        @Min(value = 1, message = "Minimum compounding frequency is 1 (yearly)")
        @Max(value = 365, message = "Maximum compounding frequency is 365 (daily)")
