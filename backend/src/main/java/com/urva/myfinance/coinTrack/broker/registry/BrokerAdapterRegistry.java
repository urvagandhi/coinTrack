 ...
 *
 * <p>Pattern: Service Locator via Spring auto-wiring. All BrokerAdapter implementations are
 * auto-discovered and registered by their getBrokerType(). O(1) lookup.
 *
 * <p>Adding a new broker (e.g. Groww) requires only: 1. Create GrowwBrokerAdapter @Component
 * implementing BrokerAdapter 2. It gets auto-registered here — zero changes to this class.
 */
@Service
