...
/**
 * Centralized logging message patterns for consistency across the application. Use these constants
 * to maintain uniform log formatting.
 *
 * <p>Pattern: [Context] Action - details
 *
 * <p>All logs automatically include requestId via MDC.
 */
public final class LoggingConstants {
  ...
  // ============ Broker Operations ============
  public static final String BROKER_CONNECT_STARTED =
      "[Broker] Connection initiated for {} - user: {}";
  public static final String BROKER_CONNECT_SUCCESS =
      "[Broker] Connected successfully to {} - user: {}";
  public static final String BROKER_CONNECT_FAILED =
      "[Broker] Connection failed for {} - user: {} - error: {}";
  ...
  public static final String BROKER_CREDENTIALS_SAVED =
      "[Broker] Credentials saved for {} - user: {}";
  public static final String BROKER_API_CALL_STARTED = "[Broker] API call to {} - endpoint: {}";
  public static final String BROKER_API_CALL_SUCCESS =
      "[Broker] API call successful to {} - endpoint: {}";
  public static final String BROKER_API_CALL_FAILED =
      "[Broker] API call failed to {} - endpoint: {} - error: {}";

  // ============ Portfolio Sync ============
  public static final String SYNC_STARTED = "[Sync] Portfolio sync started for user: {}";
  public static final String SYNC_COMPLETED =
      "[Sync] Portfolio sync completed for user: {} - holdings: {}, positions: {}";
  public static final String SYNC_FAILED = "[Sync] Portfolio sync failed for user: {} - error: {}";
  public static final String SYNC_SKIPPED_LOCK =
      "[Sync] Sync skipped for user: {} - reason: lock already held";
  public static final String SYNC_SKIPPED_STALE =
      "[Sync] Sync skipped - data is not stale (last sync: {})";
