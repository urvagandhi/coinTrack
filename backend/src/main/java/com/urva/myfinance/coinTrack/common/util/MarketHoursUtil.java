...
/**
 * Shared utility for checking Indian stock market (NSE/BSE) trading hours. Market hours: 9:15 AM –
 * 3:30 PM IST, Monday–Friday.
 */
public final class MarketHoursUtil {
  ...
  /**
   * Returns true if the Indian stock market is currently open. Checks weekday + 9:15–15:30 IST
   * window.
   */
