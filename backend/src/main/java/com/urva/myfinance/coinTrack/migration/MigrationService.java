...
public class MigrationService {
    ...
    public void recordMigration(String migrationId, String version, String description, int documentsModified) {
    ...
    public void recordMigrationFailure(String migrationId, String version, String description, String errorMessage) {
        MigrationRecord record = MigrationRecord.builder()
                .id(migrationId)
                .migrationId(migrationId)
                .version(version)
