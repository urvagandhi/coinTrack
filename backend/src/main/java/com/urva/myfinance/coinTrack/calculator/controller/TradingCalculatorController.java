...
/**
 * REST Controller for Trading Calculators. All endpoints are public (no authentication required)
 * with rate limiting.
 */
@RestController
...
public class TradingCalculatorController {
  ...
  /** Calculate brokerage and all charges. POST /api/calculators/trading/brokerage */
  ...
  public ResponseEntity<CalculatorResponse<BrokerageResponse>> calculateBrokerage(
    ...
    logger.info(
        "Brokerage calculation: type={}, buy={}, sell={}, qty={}",
  ...
  /** Calculate Margin requirements. POST /api/calculators/trading/margin */
  ...
  public ResponseEntity<CalculatorResponse<MarginResponse>> calculateMargin(
    ...
    logger.info(
        "Margin calculation: segmentType={}, tradeValue={}",
        request.segmentType(),
        request.tradeValue());
