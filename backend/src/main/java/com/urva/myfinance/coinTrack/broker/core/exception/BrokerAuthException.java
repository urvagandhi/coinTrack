...
/**
 * Thrown when broker authentication fails — token expired, invalid credentials, or session revoked.
 *
 * <p>Zerodha: HTTP 401/403 Angel One: HTTP 200 with errorcode "AB1010" Upstox: HTTP 401/403
 *
 * <p>Triggers: mark BrokerAccount as EXPIRED, notify user via NotificationService.
 */
@Getter
