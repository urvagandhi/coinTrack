...
public record HraRequest(
    @NotNull(message = "Basic salary is required")
        @DecimalMin(value = "1", message = "Basic salary must be positive")
        BigDecimal basicSalary,
    @NotNull(message = "DA is required") @DecimalMin(value = "0", message = "DA cannot be negative")
        BigDecimal dearnessAllowance,
    @NotNull(message = "HRA received is required")
        @DecimalMin(value = "0", message = "HRA cannot be negative")
        BigDecimal hraReceived,
    @NotNull(message = "Rent paid is required")
        @DecimalMin(value = "0", message = "Rent cannot be negative")
        BigDecimal rentPaid,
