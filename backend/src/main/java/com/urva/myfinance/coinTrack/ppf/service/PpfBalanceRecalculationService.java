...
public class PpfBalanceRecalculationService {
  ...
  private static final Logger logger =
      LoggerFactory.getLogger(PpfBalanceRecalculationService.class);
  ...
  /**
   * Recalculates the entire ledger for a given user. Must be called within a MongoDB transaction
   * context or be annotated with @Transactional.
   */
  @Transactional
