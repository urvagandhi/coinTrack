...
public class MongoConfig {
  ...
  @ReadingConverter
  private static class StringToGainTypeConverter
      implements Converter<String, com.urva.myfinance.coinTrack.mutualfund.model.GainType> {
    @Override
    public com.urva.myfinance.coinTrack.mutualfund.model.GainType convert(String source) {
      if (source == null || source.isEmpty()) return null;
      if ("STCG/LTCG".equals(source))
        return com.urva.myfinance.coinTrack.mutualfund.model.GainType.STCG_LTCG;
      if ("STCL/LTCL".equals(source))
        return com.urva.myfinance.coinTrack.mutualfund.model.GainType.STCL_LTCL;
      return com.urva.myfinance.coinTrack.mutualfund.model.GainType.valueOf(source);
    }
  }

  @WritingConverter
  private static class GainTypeToStringConverter
      implements Converter<com.urva.myfinance.coinTrack.mutualfund.model.GainType, String> {
    @Override
    public String convert(com.urva.myfinance.coinTrack.mutualfund.model.GainType source) {
      if (source == null) return null;
      if (source == com.urva.myfinance.coinTrack.mutualfund.model.GainType.STCG_LTCG)
        return "STCG/LTCG";
      if (source == com.urva.myfinance.coinTrack.mutualfund.model.GainType.STCL_LTCL)
        return "STCL/LTCL";
      return source.name();
    }
  }
