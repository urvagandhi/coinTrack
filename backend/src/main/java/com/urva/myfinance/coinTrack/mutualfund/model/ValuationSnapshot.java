...
/**
 * Time-Series collection: MongoDB uses columnar compression for this data. Each daily snapshot is a
 * time-series measurement keyed by (userId + platform). Granularity.HOURS is suitable for daily
 * snapshots.
 */
