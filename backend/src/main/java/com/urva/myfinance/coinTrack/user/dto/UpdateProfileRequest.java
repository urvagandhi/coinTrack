...
/**
 * Request body for PUT /api/users/me — replaces raw User-entity binding so the mass-assignment
 * surface is exactly these seven editable fields. Password, TOTP, provider and lockout fields are
