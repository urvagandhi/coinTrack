...
public class TaxCalculatorServiceImplTest {
  ...
  @Mock private CalculatorConfigLoader configLoader;

  @InjectMocks private TaxCalculatorServiceImpl taxCalculatorService;
  ...
  void testNewRegimeRebateExact() {
    ...
    IncomeTaxRequest request =
        new IncomeTaxRequest(
            new BigDecimal("1275000"),
            BigDecimal.ZERO,
            BigDecimal.ZERO,
            BigDecimal.ZERO,
            BigDecimal.ZERO,
            false,
            "2024-25");
    CalculatorResponse<IncomeTaxResponse> response =
        taxCalculatorService.calculateIncomeTax(request, false);
