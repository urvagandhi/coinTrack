...
class CalculatorResponseTest {
  ...
  void success_CreatesResponse() {
    CalculatorResponse<String> response =
        CalculatorResponse.success(
            CalculatorResponse.CalculatorMetadata.of("emi", "loans"), "result-data", null);
  ...
  void success_WithBreakdown() {
    var breakdown =
        List.of(
            new CalculatorResponse.YearlyBreakdown(
                1, new BigDecimal("1000"), new BigDecimal("500"), new BigDecimal("9000")));

    CalculatorResponse<EmiResponse> response =
        CalculatorResponse.success(
  ...
  void successWithDebug_CreatesResponse() {
    CalculatorResponse<String> response =
        CalculatorResponse.successWithDebug(
            CalculatorResponse.CalculatorMetadata.of("emi", "loans"),
            "result",
            null,
            CalculatorResponse.DebugInfo.of(
                new BigDecimal("0.007"), 240, "E = P × r × (1+r)^n / ((1+r)^n − 1)"));
  ...
  void error_CreatesErrorResponse() {
    CalculatorResponse<String> response =
        CalculatorResponse.error("INVALID", "Bad input", "principal");
  ...
  void metadata_WithAssumptions() {
    CalculatorResponse.CalculatorMetadata metadata =
        CalculatorResponse.CalculatorMetadata.of(
            "emi", "loans", List.of("EMI is calculated using reducing balance method"));
  ...
  void debugInfo_WithoutInfo() {
    CalculatorResponse.DebugInfo debug =
        CalculatorResponse.DebugInfo.of(new BigDecimal("0.007"), 120, "EMI formula");
  ...
  void debugInfo_WithInfo() {
    ...
    CalculatorResponse.DebugInfo debug =
        CalculatorResponse.DebugInfo.withInfo(new BigDecimal("0.007"), 120, "EMI formula", info);
  ...
  void yearlyBreakdown_Fields() {
    CalculatorResponse.YearlyBreakdown yb =
        new CalculatorResponse.YearlyBreakdown(
  ...
  void simpleInterestResponse_Fields() {
    SimpleInterestResponse response =
        new SimpleInterestResponse(
  ...
  void compoundInterestResponse_Fields() {
    CompoundInterestResponse response =
        new CompoundInterestResponse(
            new BigDecimal("100000"),
            new BigDecimal("161051"),
            new BigDecimal("61051"),
  ...
  void flatVsReducingResponse_Fields() {
    FlatVsReducingResponse response =
