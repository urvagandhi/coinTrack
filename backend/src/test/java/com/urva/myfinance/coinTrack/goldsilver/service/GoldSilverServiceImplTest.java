...
class GoldSilverServiceImplTest {
  ...
  @Mock private GoldSilverInvestmentRepository repository;
  ...
  @Mock private GoldSilverCalculationService calculationService;

  private List<PurityOption> defaultPurityOptions;

  @Mock private MetalRateSnapshotRepository snapshotRepository;
  ...
  void setUp() {
    ...
    service =
        new GoldSilverServiceImpl(
            repository,
            sequenceGeneratorService,
            transactionSequenceService,
            mongoTemplate,
            calculationService,
  ...
  class AddInvestment {
    ...
    @Test
    @DisplayName(
        "LIVE rateSource with snapshot - currentMarketRate computed from effectiveBaseRate * purityFactor")
    ...
    @Test
    @DisplayName(
        "MANUAL with currentMarketRate null and no existing currentMarketRate defaults to ratePerGram")
  ...
  class GetInvestmentById {
    ...
    void notFound_throws() {
      when(repository.findByIdAndUserId("missing-id", USER_ID)).thenReturn(Optional.empty());
  ...
  class UpdateInvestment {
    ...
    void happyPath() {
      ...
      GoldSilverRequestDTO updateDto =
          GoldSilverRequestDTO.builder()
    ...
    void notFound_throws() {
      ...
      assertThrows(
          DomainException.class, () -> service.updateInvestment("missing-id", updateDto, USER_ID));
    }
  ...
  class UpdateRateMode {
    ...
    void manualWithPositiveRate() {
      ...
      RateModeUpdateRequestDTO dto =
          RateModeUpdateRequestDTO.builder()
              .rateSource(RateSource.MANUAL)
    ...
    void liveMode() {
      ...
      RateModeUpdateRequestDTO dto =
          RateModeUpdateRequestDTO.builder().rateSource(RateSource.LIVE).build();
    ...
    void notFound_throws() {
      ...
      assertThrows(DomainException.class, () -> service.updateRateMode("missing-id", dto, USER_ID));
    }
  }
  ...
  class GetInvestments {
    ...
    void noFilters() {
      ...
      Page<GoldSilverResponseDTO> result =
          service.getInvestments(
              USER_ID, null, null, null, null, null, null, null, null, null, "desc", 0, 10);
    ...
    void withData() {
      GoldSilverInvestment silverInv =
          GoldSilverInvestment.builder()
              .id("inv-002")
              .itemNo(102L)
              .userId(USER_ID)
  ...
  class UpdateMarketRate {
    ...
    void updatesManualRecords() {
      GoldSilverInvestment manualInv =
          GoldSilverInvestment.builder()
              .id("inv-m1")
              .userId(USER_ID)
              .metalType(MetalType.GOLD)
      ...
      when(mongoTemplate.bulkOps(
              eq(BulkOperations.BulkMode.UNORDERED), eq(GoldSilverInvestment.class)))
          .thenReturn(bulkOps);
      when(bulkOps.updateOne(any(Query.class), any(Update.class))).thenReturn(bulkOps);

      MarketRateUpdateRequestDTO dto =
          MarketRateUpdateRequestDTO.builder()
              .metalType(MetalType.GOLD)
    ...
    void includeMaturedTrue() {
      GoldSilverInvestment maturedInv =
          GoldSilverInvestment.builder()
              .id("inv-m2")
              .userId(USER_ID)
              .metalType(MetalType.GOLD)
  ...
  class GetAllForExport {
    ...
    void returnsFullList() {
      ...
      List<GoldSilverResponseDTO> result =
          service.getAllForExport(
              USER_ID, null, null, null, null, null, null, null, null, null, "desc");
    ...
    void emptyList() {
      ...
      List<GoldSilverResponseDTO> result =
          service.getAllForExport(
              USER_ID, MetalType.GOLD, null, null, null, null, null, null, null, null, null);
