...
public class UserAuthenticationServiceGoogleTest {
  ...
  @InjectMocks private UserAuthenticationService authService;
  ...
  public void testAuthenticateGoogle_NewUser() {
    ...
    com.urva.myfinance.coinTrack.user.model.PendingRegistration pending =
        new com.urva.myfinance.coinTrack.user.model.PendingRegistration();
  ...
  public void testCompleteRegistrationWithTotp_PersistsBackupCodes() {
    ...
    // Act
    LoginResponse response =
        authService.completeRegistrationWithTotp(tempToken, totpCode, "device", "ip");
  ...
  public void testAuthenticateGoogle_ExistingLocalAccountLinking_Success() {
    ...
    when(jwtService.generateRefreshToken(eq("local123"), any(), any()))
  ...
  public void testAuthenticateGoogle_ExistingLocalAccountLinking_UnverifiedEmail_ThrowsException() {
    ...
    com.urva.myfinance.coinTrack.common.exception.AuthenticationException exception =
        assertThrows(
  ...
  public void testAuthenticateGoogle_TotpBypass_Success() {
    ...
    when(jwtService.generateToken(any(User.class))).thenReturn("access-token-123");
    when(jwtService.generateRefreshToken(eq("user123"), any(), any()))
        .thenReturn("refresh-token-123");
