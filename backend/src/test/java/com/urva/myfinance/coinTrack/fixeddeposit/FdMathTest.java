...
class FdMathTest {
    ...
    void testCumulative5YearQuarterly() {
        FdMath.MaturityResult result = FdMath.computeMaturity(
                PRINCIPAL_1L, RATE_7, ISSUE_DATE, MATURITY_5Y,
                FdType.CUMULATIVE, CompoundingFrequency.QUARTERLY, false, InterestPayoutFrequency.AT_MATURITY);
    ...
    void testSeniorCitizenFlagNoRateBonus() {
        ...
        FdMath.MaturityResult regular = FdMath.computeMaturity(
                PRINCIPAL_1L, RATE_7, ISSUE_DATE, MATURITY_5Y,
                FdType.CUMULATIVE, CompoundingFrequency.QUARTERLY, false, InterestPayoutFrequency.AT_MATURITY);

        FdMath.MaturityResult senior = FdMath.computeMaturity(
                PRINCIPAL_1L, RATE_7, ISSUE_DATE, MATURITY_5Y,
                FdType.CUMULATIVE, CompoundingFrequency.QUARTERLY, true, InterestPayoutFrequency.AT_MATURITY);
    ...
    void testCompoundingFrequency(CompoundingFrequency freq, int periods) {
        FdMath.MaturityResult result = FdMath.computeMaturity(
                PRINCIPAL_1L, RATE_7, ISSUE_DATE, MATURITY_5Y,
                FdType.CUMULATIVE, freq, false, InterestPayoutFrequency.AT_MATURITY);
    ...
    void testNonCumulativeSimpleInterest() {
        FdMath.MaturityResult result = FdMath.computeMaturity(
                PRINCIPAL_1L, RATE_7, ISSUE_DATE, MATURITY_5Y,
                FdType.NON_CUMULATIVE, CompoundingFrequency.QUARTERLY, false, InterestPayoutFrequency.QUARTERLY);
        ...
        BigDecimal dailyRate = RATE_7
                .divide(new BigDecimal("100"), 10, RoundingMode.HALF_EVEN)
                .divide(new BigDecimal("365"), 10, RoundingMode.HALF_EVEN);
        BigDecimal expectedInterest = PRINCIPAL_1L
                .multiply(dailyRate).multiply(BigDecimal.valueOf(days)).setScale(2, RoundingMode.HALF_EVEN);
    ...
    void testShortTenureSimpleInterest() {
        FdMath.MaturityResult result = FdMath.computeMaturity(
                PRINCIPAL_1L, RATE_7, ISSUE_DATE, MATURITY_6M,
                FdType.CUMULATIVE, CompoundingFrequency.QUARTERLY, false, InterestPayoutFrequency.AT_MATURITY);

        assertNotNull(result);
        // Should use simple interest for < 181 days
        BigDecimal expectedInterest = PRINCIPAL_1L.multiply(RATE_7).multiply(new BigDecimal("181"))
    ...
    void testCalculateInterestRateFromMaturity() {
        ...
        BigDecimal rate = FdMath.computeInterestRateFromMaturity(
                PRINCIPAL_1L, maturity, ISSUE_DATE, MATURITY_1Y,
                FdType.CUMULATIVE, CompoundingFrequency.QUARTERLY, false);
    ...
    void testPrematureWithdrawalSmallFd() {
        ...
        FdMath.PrematureWithdrawalResult result = FdMath.computePrematureWithdrawal(
                PRINCIPAL_1L, RATE_7, ISSUE_DATE, MATURITY_5Y, withdrawalDate,
                FdType.CUMULATIVE, CompoundingFrequency.QUARTERLY,
                new BigDecimal("0.50"), false);
    ...
    void testPrematureWithdrawalLargeFd() {
        ...
        FdMath.PrematureWithdrawalResult result = FdMath.computePrematureWithdrawal(
                largePrincipal, RATE_7, ISSUE_DATE, MATURITY_5Y, withdrawalDate,
                FdType.CUMULATIVE, CompoundingFrequency.QUARTERLY,
    ...
    void testPrematureWithdrawalLessThan7Days() {
        ...
        FdMath.PrematureWithdrawalResult result = FdMath.computePrematureWithdrawal(
                PRINCIPAL_1L, RATE_7, ISSUE_DATE, MATURITY_5Y, earlyWithdrawal,
                FdType.CUMULATIVE, CompoundingFrequency.QUARTERLY,
                new BigDecimal("0.50"), false);
    ...
    void testPrematureWithdrawalNonCumulative() {
        ...
        FdMath.PrematureWithdrawalResult result = FdMath.computePrematureWithdrawal(
                PRINCIPAL_1L, RATE_7, ISSUE_DATE, MATURITY_5Y, withdrawalDate,
                FdType.NON_CUMULATIVE, CompoundingFrequency.QUARTERLY,
                new BigDecimal("0.50"), false);
    ...
    void testTdsRegularBelowThreshold() {
        FdMath.TdsResult result = FdMath.computeTds(
                new BigDecimal("30000"), false, true, false);
    ...
    void testTdsRegularAboveThreshold() {
        FdMath.TdsResult result = FdMath.computeTds(
                new BigDecimal("60000"), false, true, false);
    ...
    void testTdsSeniorBelowThreshold() {
        FdMath.TdsResult result = FdMath.computeTds(
                new BigDecimal("80000"), true, true, false);
    ...
    void testTdsSeniorAboveThreshold() {
        FdMath.TdsResult result = FdMath.computeTds(
                new BigDecimal("120000"), true, true, false);
    ...
    void testTdsNoPan() {
        FdMath.TdsResult result = FdMath.computeTds(
                new BigDecimal("60000"), false, false, false);
    ...
    void testTdsForm15g15h() {
        FdMath.TdsResult result = FdMath.computeTds(
                new BigDecimal("60000"), false, true, true);
    ...
    void testZeroInterest() {
        ...
        FdMath.TdsResult result2 = FdMath.computeTds(
                new BigDecimal("-1000"), false, true, false);
    ...
    void testOneDayTenure() {
        ...
        FdMath.MaturityResult result = FdMath.computeMaturity(
                PRINCIPAL_1L, RATE_7, ISSUE_DATE, tomorrow,
                FdType.CUMULATIVE, CompoundingFrequency.QUARTERLY, false, InterestPayoutFrequency.AT_MATURITY);
    ...
    @Test
    @DisplayName("Bank-level: several FDs at one bank, none over ₹50k alone, sum crosses → TDS applies")
    void testBankLevelAggregationTriggersTds() {
        // Three FDs at HDFC each earning ₹20k = ₹60k total → crosses ₹50k regular threshold.
        List<FdMath.FdTdsInput> inputs = List.of(
    ...
    void testBankLevelNoAggregationAcrossBanks() {
        ...
        List<FdMath.FdTdsInput> bankA = List.of(
                new FdMath.FdTdsInput(new BigDecimal("10000"), false, true, false),
                new FdMath.FdTdsInput(new BigDecimal("10000"), false, true, false)
        );
        List<FdMath.FdTdsInput> bankB = List.of(
                new FdMath.FdTdsInput(new BigDecimal("20000"), false, true, false)
        );
    ...
    void testFyAccrualSplitsLifetimeIntoPerYearBands() {
        ...
        BigDecimal fy2025 = FdMath.computeFyAccruedInterest(
                PRINCIPAL_1L, RATE_7, issue, maturity,
                FdType.CUMULATIVE, CompoundingFrequency.QUARTERLY,
                LocalDate.of(2025, 4, 1), LocalDate.of(2026, 3, 31));
        BigDecimal fy2026 = FdMath.computeFyAccruedInterest(
                PRINCIPAL_1L, RATE_7, issue, maturity,
                FdType.CUMULATIVE, CompoundingFrequency.QUARTERLY,
                LocalDate.of(2026, 4, 1), LocalDate.of(2027, 3, 31));
        BigDecimal fy2027 = FdMath.computeFyAccruedInterest(
                PRINCIPAL_1L, RATE_7, issue, maturity,
                FdType.CUMULATIVE, CompoundingFrequency.QUARTERLY,
        ...
        // Sum of per-FY bands should track (closely) the total 3-year interest on the compounding curve.
        BigDecimal totalBands = fy2025.add(fy2026).add(fy2027);
        BigDecimal fullInterest = FdMath.computeMaturity(
                PRINCIPAL_1L, RATE_7, issue, maturity,
                FdType.CUMULATIVE, CompoundingFrequency.QUARTERLY, false, InterestPayoutFrequency.AT_MATURITY)
                .totalInterest();
        ...
        assertTrue(fullInterest.subtract(totalBands).compareTo(new BigDecimal("500.00")) <= 0,
                "per-FY bands should exhaust ~all of the total interest: full=" + fullInterest
                        + " bands=" + totalBands);
    }
    ...
    void testFyAccrualNoOverlap() {
        ...
        BigDecimal accrued = FdMath.computeFyAccruedInterest(
                PRINCIPAL_1L, RATE_7, LocalDate.of(2024, 1, 1), LocalDate.of(2024, 12, 31),
                FdType.CUMULATIVE, CompoundingFrequency.QUARTERLY,
                LocalDate.of(2026, 4, 1), LocalDate.of(2027, 3, 31));
    ...
    void testFyAccrualClampedToTenor() {
        ...
        BigDecimal beforeIssue = FdMath.computeFyAccruedInterest(
                PRINCIPAL_1L, RATE_7, LocalDate.of(2025, 6, 1), LocalDate.of(2026, 1, 31),
                FdType.CUMULATIVE, CompoundingFrequency.QUARTERLY,
        ...
        BigDecimal overlap = FdMath.computeFyAccruedInterest(
                PRINCIPAL_1L, RATE_7, LocalDate.of(2025, 6, 1), LocalDate.of(2026, 1, 31),
                FdType.CUMULATIVE, CompoundingFrequency.QUARTERLY,
                LocalDate.of(2025, 4, 1), LocalDate.of(2026, 3, 31));
        ...
        BigDecimal afterMaturity = FdMath.computeFyAccruedInterest(
                PRINCIPAL_1L, RATE_7, LocalDate.of(2025, 6, 1), LocalDate.of(2026, 1, 31),
                FdType.CUMULATIVE, CompoundingFrequency.QUARTERLY,
                LocalDate.of(2027, 4, 1), LocalDate.of(2028, 3, 31));
    ...
    void testFyAccrualNonCumulative() {
        ...
        BigDecimal expected = PRINCIPAL_1L.multiply(RATE_7.divide(new BigDecimal("100"), 10, RoundingMode.HALF_EVEN))
                .multiply(BigDecimal.valueOf(days)).divide(BigDecimal.valueOf(365), 10, RoundingMode.HALF_EVEN);
