...
class EncryptionUtilTest {
  ...
  void staticEncrypt_NullKey_Throws() {
    assertThrows(IllegalArgumentException.class, () -> EncryptionUtil.encrypt("data", null));
  }
  ...
  void staticEncrypt_WrongLengthKey_Throws() {
    assertThrows(IllegalArgumentException.class, () -> EncryptionUtil.encrypt("data", "short"));
  }
  ...
  void staticEncrypt_NullPlaintext_Throws() {
    assertThrows(IllegalArgumentException.class, () -> EncryptionUtil.encrypt(null, TEST_KEY));
  }

  @Test
  @DisplayName("25. Static decrypt null ciphertext throws")
  void staticDecrypt_NullCiphertext_Throws() {
    assertThrows(IllegalArgumentException.class, () -> EncryptionUtil.decrypt(null, TEST_KEY));
  }
  ...
  void crossKeyDecryption_Fails() {
    ...
    assertThrows(RuntimeException.class, () -> EncryptionUtil.decrypt(encrypted, otherKey));
  }
