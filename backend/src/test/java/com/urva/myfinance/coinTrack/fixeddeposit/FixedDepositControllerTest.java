...
class FixedDepositControllerTest {
    ...
    void testCreateFixedDeposit() {
        FixedDepositRequestDTO request = FixedDepositRequestDTO.builder()
                .place("HDFC Bank")
        ...
        FixedDepositResponseDTO expected = FixedDepositResponseDTO.builder()
                .id("fd_1")
                .fdNo(1L)
                .userId("user_1")
                .place("HDFC Bank")
        ...
        ResponseEntity<ApiResponse<FixedDepositResponseDTO>> response = fixedDepositController.createFixedDeposit(
                request, createUserPrincipal());
    ...
    void testGetFixedDeposits() {
        FixedDepositResponseDTO fd = FixedDepositResponseDTO.builder()
                .id("fd_1")
                .fdNo(1L)
                .userId("user_1")
                .place("HDFC Bank")
        ...
        when(fixedDepositService.getFixedDeposits(eq("user_1"), any(), any(), any(), any(), any(), any(), any(), eq(0), eq(20)))
                .thenReturn(page);

        ResponseEntity<ApiResponse<org.springframework.data.domain.Page<FixedDepositResponseDTO>>> response =
                fixedDepositController.getFixedDeposits(createUserPrincipal(), null, null, null, null, null,
                        "maturityDate", "asc", 0, 20);
    ...
    void testGetSummary() {
        FixedDepositSummaryDTO summary = FixedDepositSummaryDTO.builder()
        ...
        ResponseEntity<ApiResponse<FixedDepositSummaryDTO>> response = fixedDepositController.getSummary(createUserPrincipal());

        assertEquals(200, response.getStatusCodeValue());
        assertEquals(0, response.getBody().getData().getTotalTdsDeducted().compareTo(new BigDecimal("1000")));
    }
    ...
    void testGetFixedDepositById() {
        ...
        ResponseEntity<ApiResponse<FixedDepositResponseDTO>> response = fixedDepositController.getFixedDepositById("fd_1", createUserPrincipal());
    ...
    void testUpdateFixedDeposit() {
        ...
        when(fixedDepositService.updateFixedDeposit(eq("fd_1"), any(FixedDepositRequestDTO.class), eq("user_1")))
                .thenReturn(expected);

        ResponseEntity<ApiResponse<FixedDepositResponseDTO>> response = fixedDepositController.updateFixedDeposit(
                "fd_1", request, createUserPrincipal());
    ...
    void testCloseFixedDeposit() {
        ...
        ResponseEntity<ApiResponse<FixedDepositResponseDTO>> response = fixedDepositController.closeFixedDeposit("fd_1", createUserPrincipal());
    ...
    void testDeleteFixedDeposit() {
        ...
        ResponseEntity<ApiResponse<Void>> response = fixedDepositController.deleteFixedDeposit("fd_1", createUserPrincipal());
    ...
    void testPrematureWithdraw() {
        PrematureWithdrawalRequestDTO request = PrematureWithdrawalRequestDTO.builder()
                .withdrawalDate(LocalDate.of(2025, 1, 8))
                .build();

        PrematureWithdrawalResponseDTO expected = PrematureWithdrawalResponseDTO.builder()
                .fdId("fd_1")
                .fdNo(1L)
                .withdrawalDate(LocalDate.of(2025, 1, 8))
        ...
        when(fixedDepositService.prematureWithdraw(eq("fd_1"), any(PrematureWithdrawalRequestDTO.class), eq("user_1")))
                .thenReturn(expected);

        ResponseEntity<ApiResponse<PrematureWithdrawalResponseDTO>> response = fixedDepositController.prematureWithdraw(
                "fd_1", request, createUserPrincipal());

        assertEquals(200, response.getStatusCodeValue());
        assertEquals(0, response.getBody().getData().getRealizedMaturityAmount().compareTo(new BigDecimal("120000")));
    }

    @Test
    @DisplayName("GET /api/fixed-deposits/{id}/tds returns TDS detail")
    void testGetTdsDetail() {
        FdTdsDetailDTO expected = FdTdsDetailDTO.builder()
                .fdId("fd_1")
                .fdNo(1L)
                .financialYear(2024)
        ...
        ResponseEntity<ApiResponse<FdTdsDetailDTO>> response = fixedDepositController.getTdsDetail(
                "fd_1", 2024, createUserPrincipal());

        assertEquals(200, response.getStatusCodeValue());
        assertEquals(0, response.getBody().getData().getTdsDeducted().compareTo(new BigDecimal("1000")));
    }

    @Test
    @DisplayName("GET /api/fixed-deposits/tds-summary returns TDS summary for all FDs")
    void testGetTdsSummary() {
        FdTdsDetailDTO fd1 = FdTdsDetailDTO.builder()
                .fdId("fd_1")
                .fdNo(1L)
                .financialYear(2024)
                .tdsDeducted(new BigDecimal("1000"))
        ...
        FdTdsDetailDTO fd2 = FdTdsDetailDTO.builder()
                .fdId("fd_2")
                .fdNo(2L)
                .financialYear(2024)
        ...
        ResponseEntity<ApiResponse<List<FdTdsDetailDTO>>> response = fixedDepositController.getTdsSummary(
                2024, createUserPrincipal());
