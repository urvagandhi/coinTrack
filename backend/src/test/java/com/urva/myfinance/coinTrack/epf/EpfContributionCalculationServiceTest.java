...
class EpfContributionCalculationServiceTest {
  ...
  void testAutoSalaryCalculationWithStatutoryEpsCap() {
    ...
    CalculationResult result =
        calculationService.calculate(basicDA, rate, useActualSalaryForEps, vpfAmount);
  ...
  @Test
  @DisplayName(
      "2. Auto salary calculation with basicDA > ₹15,000 and uncapped actual salary EPS override")
  void testAutoSalaryCalculationWithUncappedEpsOverride() {
    ...
    CalculationResult result =
        calculationService.calculate(basicDA, rate, useActualSalaryForEps, BigDecimal.ZERO);
  ...
  void testReducedEmployeeContributionRate() {
    ...
    CalculationResult result = calculationService.calculate(basicDA, rate, false, BigDecimal.ZERO);
