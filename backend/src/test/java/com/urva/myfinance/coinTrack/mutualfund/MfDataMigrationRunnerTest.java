...
public class MfDataMigrationRunnerTest {
  ...
  @Autowired private MfSchemeRepository mfSchemeRepository;
  @Autowired private LumpsumTransactionRepository lumpsumTransactionRepository;
  @Autowired private SipContributionRepository sipContributionRepository;
  @Autowired private RedemptionTransactionRepository redemptionTransactionRepository;
  ...
  public void runMigration() {
    ...
    lumpsumTransactionRepository
        .findByUserId(userId)
        .forEach(l -> lumpsumTransactionRepository.delete(l));
    sipContributionRepository
        .findByUserId(userId)
        .forEach(s -> sipContributionRepository.delete(s));
    redemptionTransactionRepository
        .findByUserId(userId)
        .forEach(r -> redemptionTransactionRepository.delete(r));
    ...
    schemeMap.put(
        ...
        createScheme(
            userId,
            "Parag Parekh Flexi Cap Fund - Direct growth plan",
            "Flexi cap",
            "CAMS",
            "SBI",
            "10757672",
    ...
    schemeMap.put(
        ...
        createScheme(
            userId,
            "SBI Multicap Fund - Direct Growth plan",
            "Multicap",
            "CAMS",
            "SBI",
            "29768466",
    ...
    schemeMap.put(
        ...
        createScheme(
            userId,
            "HDFC Multicap Fund - Direct growth plan",
            "Multicap",
            "CAMS",
            "SBI",
            "27471737/63",
    ...
    schemeMap.put(
        ...
        createScheme(
            userId,
            "Bandhan Small Cap Fund - Direct Growth plan",
            "Small cap",
            "CAMS",
            "SBI",
            "7089577",
    ...
    schemeMap.put(
        ...
        createScheme(
            userId,
            "HDFC Mid Cap Fund - Direct Growth plan",
            "Mid cap",
            "CAMS",
            "SBI",
            "27471737",
    ...
    schemeMap.put(
        ...
        createScheme(
            userId,
            "Mirae Asset Large & Midcap Fund - Direct Growth plan",
            "Large & Mid cap",
            "Karvy",
            "SBI",
            "79935473441",
    ...
    schemeMap.put(
        ...
        createScheme(
            userId,
            "Mirae Asset Midcap Fund - Direct growth plan",
            "Mid cap",
            "Karvy",
            "SBI",
            "79935473441",
    ...
    schemeMap.put(
        ...
        createScheme(
            userId,
            "Canara Robeco bluechip Fund - Direct growth plan",
            "Large cap",
            "Karvy",
            "SBI",
            "19926270126",
    ...
    schemeMap.put(
        ...
        createScheme(
            userId,
            "Motilal Oswal Large & Midcap Fund - Direct Growth plan",
            "Large & Mid cap",
            "Karvy",
            "SBI",
            "",
    ...
    generateSIPs(
        userId,
        schemeMap.get("SBI Multicap"),
        LocalDate.of(2022, 8, 5),
        LocalDate.of(2024, 5, 5),
        4000);
    generateSIPs(
        userId,
        schemeMap.get("SBI Small Cap"),
    ...
    generateSIPs(
        userId,
        schemeMap.get("Mirae Large & Midcap"),
        LocalDate.of(2021, 3, 5),
        LocalDate.of(2025, 8, 5),
        2500);
    generateSIPs(
        userId,
        schemeMap.get("Mirae Midcap"),
        LocalDate.of(2021, 10, 5),
        LocalDate.of(2024, 5, 5),
        3000);
    generateSIPs(
        userId,
        schemeMap.get("Canara Robeco"),
    ...
    generateSIPs(
        userId,
        schemeMap.get("Bandhan Small Cap"),
        LocalDate.of(2025, 10, 5),
        LocalDate.of(2026, 8, 5),
        5000);
    generateSIPs(
        userId,
        schemeMap.get("HDFC Mid Cap"),
        LocalDate.of(2025, 10, 5),
        LocalDate.of(2026, 8, 5),
        5000);
  ...
  private void addRedemption(
      String userId, MfScheme scheme, String dateStr, double units, double value) {
  ...
  private void generateSIPs(
      String userId, MfScheme scheme, LocalDate start, LocalDate end, double amount) {
