...
class PrematureWithdrawalTest {
    ...
    private FixedDeposit createActiveFd(String fdId, BigDecimal principal, BigDecimal rate, boolean isTaxSaver) {
    ...
    void testWithdrawSmallFdAfter7Days() {
        FixedDeposit fd = createActiveFd("fd_1", new BigDecimal("100000"), new BigDecimal("7.00"), false);
        ...
        PrematureWithdrawalResponseDTO result = fixedDepositService.prematureWithdraw("fd_1", request, "user_A");
        ...
        System.out.println("Small FD penalty: " + result.getPenaltyAmount() + ", Realized: " + result.getRealizedMaturityAmount());
    }

    @Test
    @DisplayName("Withdraw after 7 days, large FD (>₹5L) → 1% penalty")
    void testWithdrawLargeFdAfter7Days() {
        FixedDeposit fd = createActiveFd("fd_2", new BigDecimal("600000"), new BigDecimal("7.00"), false);
        ...
        PrematureWithdrawalResponseDTO result = fixedDepositService.prematureWithdraw("fd_2", request, "user_A");
    ...
    void testWithdrawBefore7Days() {
        FixedDeposit fd = createActiveFd("fd_3", new BigDecimal("100000"), new BigDecimal("7.00"), false);
        ...
        PrematureWithdrawalResponseDTO result = fixedDepositService.prematureWithdraw("fd_3", request, "user_A");
    ...
    void testTaxSaverFdWithdrawBlocked() {
        FixedDeposit fd = createActiveFd("fd_4", new BigDecimal("100000"), new BigDecimal("7.00"), true);
        ...
        InvalidWithdrawalException ex = assertThrows(InvalidWithdrawalException.class,
    ...
    void testAlreadyWithdrawnFd() {
        FixedDeposit fd = createActiveFd("fd_5", new BigDecimal("100000"), new BigDecimal("7.00"), false);
    ...
    void testAlreadyClosedFd() {
        FixedDeposit fd = createActiveFd("fd_6", new BigDecimal("100000"), new BigDecimal("7.00"), false);
    ...
    void testWithdrawalBeforeIssueDate() {
        FixedDeposit fd = createActiveFd("fd_7", new BigDecimal("100000"), new BigDecimal("7.00"), false);
        when(fixedDepositRepository.findByIdAndUserId("fd_7", "user_A")).thenReturn(Optional.of(fd));

        PrematureWithdrawalRequestDTO request = PrematureWithdrawalRequestDTO.builder()
                .withdrawalDate(LocalDate.of(2023, 12, 31))
                .build();
    ...
    void testWithdrawalAfterMaturityDate() {
        FixedDeposit fd = createActiveFd("fd_8", new BigDecimal("100000"), new BigDecimal("7.00"), false);
        when(fixedDepositRepository.findByIdAndUserId("fd_8", "user_A")).thenReturn(Optional.of(fd));

        PrematureWithdrawalRequestDTO request = PrematureWithdrawalRequestDTO.builder()
                .withdrawalDate(LocalDate.of(2030, 1, 1))
                .build();
    ...
    void testPenaltyRateOverride() {
        FixedDeposit fd = createActiveFd("fd_9", new BigDecimal("100000"), new BigDecimal("7.00"), false);
        ...
        PrematureWithdrawalResponseDTO result = fixedDepositService.prematureWithdraw("fd_9", request, "user_A");
    ...
    void testNonCumulativeFdWithdrawal() {
        FixedDeposit fd = createActiveFd("fd_10", new BigDecimal("100000"), new BigDecimal("7.00"), false);
        ...
        PrematureWithdrawalResponseDTO result = fixedDepositService.prematureWithdraw("fd_10", request, "user_A");
