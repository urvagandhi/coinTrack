...
class TotpServiceTest {
  ...
  void setUp() {
    ...
    ReflectionTestUtils.setField(
        totpService, "totpEncryptionKey", "12345678901234567890123456789012");
  ...
  void verifySetup_noPending_throws() {
    ...
    RuntimeException ex =
        assertThrows(RuntimeException.class, () -> totpService.verifySetup(sampleUser, "123456"));
  ...
  void verifySetup_invalidCode_throws() {
    ...
    RuntimeException ex =
        assertThrows(RuntimeException.class, () -> totpService.verifySetup(sampleUser, "000000"));
  ...
  void verifyLogin_lockedAccount_throws() {
    ...
    RuntimeException ex =
        assertThrows(RuntimeException.class, () -> totpService.verifyLogin(sampleUser, "123456"));
  ...
  void verifyBackupCode_locked_throws() {
    ...
    RuntimeException ex =
        assertThrows(
            RuntimeException.class, () -> totpService.verifyBackupCode(sampleUser, "12345678"));
    assertTrue(ex.getMessage().contains("locked"));
  }
