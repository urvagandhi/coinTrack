...
class AmfiDailySyncServiceTest {
  ...
  @Mock private MutualFundLtpRepository ltpRepository;

  @Mock private RestTemplate restTemplate;

  @InjectMocks private AmfiDailySyncService service;

  @Captor private ArgumentCaptor<List<MutualFundLtp>> captor;
  ...
  void syncDailyNavs_validData() {
    ...
    org.junit.jupiter.api.Assertions.assertEquals(
        0, new java.math.BigDecimal("106.8357").compareTo(savedList.get(0).getLatestNav()));
  }
