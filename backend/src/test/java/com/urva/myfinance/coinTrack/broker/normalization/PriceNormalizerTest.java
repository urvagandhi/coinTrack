...
class PriceNormalizerTest {
  ...
  void toBigDecimal_Null_ReturnsZero() {
    assertEquals(
        BigDecimal.ZERO.setScale(2), PriceNormalizer.toBigDecimal(null, "price", Broker.ZERODHA));
  }
  ...
  void toBigDecimal_BigDecimal_ScaledTo2() {
    BigDecimal result =
        PriceNormalizer.toBigDecimal(new BigDecimal("33.333"), "price", Broker.ZERODHA);
  ...
  void toBigDecimal_EmptyString_ReturnsZero() {
    assertEquals(
        BigDecimal.ZERO.setScale(2), PriceNormalizer.toBigDecimal("", "price", Broker.ZERODHA));
  }
  ...
  void toBigDecimal_NonNumeric_ThrowsBrokerException() {
    assertThrows(
        BrokerException.class, () -> PriceNormalizer.toBigDecimal("abc", "price", Broker.ZERODHA));
  }
  ...
  void toBigDecimal_AngelOneEmpty_ReturnsZero() {
    assertEquals(
        BigDecimal.ZERO.setScale(2), PriceNormalizer.toBigDecimal("", "price", Broker.ANGELONE));
  }
