...
class MfSchemeServiceTest {
  ...
  @InjectMocks private MfSchemeService service;
  ...
  void setUp() {
    ...
    when(portfolioHoldingRepo.findByUserIdAndSchemeId(anyString(), anyString()))
  ...
  void deleteScheme_cascades() {
    ...
    when(lumpsumRepo.findByUserIdAndSchemeId(USER_ID, SCHEME_ID))
        .thenReturn(
            List.of(new com.urva.myfinance.coinTrack.mutualfund.model.LumpsumTransaction()));
    ...
    when(redemptionRepo.findByUserIdAndSchemeId(USER_ID, SCHEME_ID))
        .thenReturn(
            List.of(new com.urva.myfinance.coinTrack.mutualfund.model.RedemptionTransaction()));
