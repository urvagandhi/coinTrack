...
class FinancialMathTest {
  ...
  class SipTests {
    ...
    void sipFutureValue_KnownInput_ReturnsExpected() {
      BigDecimal result =
          FinancialMath.sipFutureValue(new BigDecimal("5000"), new BigDecimal("12"), 10);
    ...
    void sipFutureValue_ZeroRate_ReturnsTotalInvestment() {
      BigDecimal result = FinancialMath.sipFutureValue(new BigDecimal("5000"), BigDecimal.ZERO, 5);
    ...
    void sipFutureValue_ZeroYears_ReturnsZero() {
      BigDecimal result =
          FinancialMath.sipFutureValue(new BigDecimal("5000"), new BigDecimal("12"), 0);
    ...
    void stepUpSip_GreaterThanRegular() {
      BigDecimal regular =
          FinancialMath.sipFutureValue(new BigDecimal("10000"), new BigDecimal("12"), 10);
      BigDecimal stepUp =
    ...
    void stepUpSipTotalInvestment_Correct() {
      BigDecimal total =
          FinancialMath.stepUpSipTotalInvestment(new BigDecimal("10000"), 3, new BigDecimal("10"));
      assertNotNull(total);
  ...
  class InvestmentTests {
    ...
    void lumpsumFutureValue_Correct() {
      BigDecimal result =
          FinancialMath.lumpsumFutureValue(new BigDecimal("100000"), new BigDecimal("12"), 5);
    ...
    void cagr_Correct() {
      BigDecimal result = FinancialMath.cagr(new BigDecimal("100000"), new BigDecimal("176234"), 5);
      assertNotNull(result);
      assertTrue(result.compareTo(BigDecimal.ZERO) > 0);
    }
    ...
    void inflationAdjustedFuture_Correct() {
      BigDecimal result =
          FinancialMath.inflationAdjustedFuture(new BigDecimal("100000"), new BigDecimal("6"), 5);
      assertTrue(result.compareTo(new BigDecimal("100000")) > 0);
    }
    ...
    void inflationAdjustedPresentValue_Correct() {
      BigDecimal result =
          FinancialMath.inflationAdjustedPresentValue(
    ...
    void stockAverage_SinglePurchase_ReturnsPrice() {
      List<FinancialMath.StockPurchase> purchases =
          List.of(new FinancialMath.StockPurchase(new BigDecimal("10"), new BigDecimal("100")));
  ...
  class LoanTests {
    ...
    void emi_Correct() {
      BigDecimal result = FinancialMath.emi(new BigDecimal("1000000"), new BigDecimal("8.5"), 240);
      assertNotNull(result);
      assertTrue(result.compareTo(BigDecimal.ZERO) > 0);
    }
    ...
    void totalInterest_Correct() {
      ...
      BigDecimal result = FinancialMath.totalInterest(new BigDecimal("1000000"), emi, 120);
      assertTrue(result.compareTo(BigDecimal.ZERO) > 0);
    }
    ...
    void flatRateEmi_Correct() {
      BigDecimal result =
          FinancialMath.flatRateEmi(new BigDecimal("100000"), new BigDecimal("10"), 5);
      assertTrue(result.compareTo(BigDecimal.ZERO) > 0);
    }
    ...
    void compoundInterest_Correct() {
      BigDecimal result =
          FinancialMath.compoundInterest(new BigDecimal("100000"), new BigDecimal("10"), 5, 12);
      assertTrue(result.compareTo(new BigDecimal("100000")) > 0);
    }
    ...
    void simpleInterest_Correct() {
      BigDecimal result =
          FinancialMath.simpleInterest(new BigDecimal("100000"), new BigDecimal("10"), 5);
  ...
  class XirrTests {
    ...
    void xirr_SingleCashFlow_ReturnsFailure() {
      FinancialMath.XirrResult result =
          FinancialMath.xirr(
              List.of(
    ...
    void xirr_ValidCashFlows_ReturnsResult() {
      List<FinancialMath.CashFlow> cashFlows =
          List.of(
              new FinancialMath.CashFlow(LocalDate.of(2026, 1, 1), new BigDecimal("-100000")),
